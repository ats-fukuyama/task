...
!     ****** INPUT NAMELIST ******
  ...
  SUBROUTINE WRNLIN(NID,IST,IERR)
    ...
    NAMELIST /WR/ RR,RA,RB,RKAP,RDLT,BB,Q0,QA,RIP,PROFJ, &
                  ...
                  NRAYMAX,NSTPMAX,NRDIVMAX,LMAXNW,NPMAX,NTHMAX, &
                  MDLWRI,MDLWRG,MDLWRQ,MDLWRW, &
...
!     ***** INPUT PARAMETER LIST *****
  ...
  601 FORMAT(' ','# &WR : RR,RA,RB,RKAP,RDLT,BB,Q0,QA,RIP,PROFJ,'/ &
             ...
             9X,'MODELP,MODELV,NDISP1,NDISP2,NS_NSA,PMAX,EMAX,'/ &
             ...
             9X,'NRAYMAX,NSTPMAX,NRDIVMAX,LMAXNW,NPMAX,NTHMAX,'/ &
             9X,'MDLWRI,MDLWRG,MDLWRQ,MDLWRW,'/ &
