...
2      CONTINUE
    ...
    IF(nplot.GE.1) THEN
       ...
       DO nplot=1,nplot_max
          ncountry_nplot(nplot)=ncountry_nword(nplot)
       END DO
    END IF
  ...
  SUBROUTINE cv_gout_help(id)
    ...
    CASE(2)
       WRITE(6,'((A))') &
            ...
            '    19g4: new deaths vs time (Log10 scale)', &
            ...
            '    21: total cases per population vs time (Log10 scale)', &
            '    22: total deaths per population vs time (Log10 scale)', &
            '    23: new cases per population vs time (Log10 scale)', &
            '    24: new deaths per population vs time (Log10 scale)', &
            ' 3: 31+32+33+34 ', &
       ...
       DO nplot=1,nplot_max
          ...
          CASE(6)
             DO ndate=1,ndate_max
                ...
                fg(ndate,nplot)=LOG10(MAX(1.0D0,rcases))
             END DO
          END SELECT
       END DO
       IF(nplot_max.EQ.1) THEN
       ...
       DO nplot=1,nplot_max
          ...
          CASE(7)
             DO ndate=1,ndate_max
                ...
                fg(ndate,nplot)=LOG10(MAX(1.0D0,rdeaths))
             END DO
          END SELECT
       END DO
       IF(nplot_max.EQ.1) THEN
       ...
       IF(nplot_max.EQ.1) THEN
          ...
          CASE(8)
             DO ndate=1,6
                ...
                fg(ndate,1)=LOG10(MAX(1.0D0,rcases))
                fg(ndate,2)=LOG10(1.0D0)
             END DO
             DO ndate=7,ndate_max
                rcases=ncases_new_ndate_ncountry(ndate,ncountry)
                fg(ndate,1)=LOG10(MAX(1.0D0,rcases))
                ...
                DO ndate_ave=ndate-6,ndate
                   rcases=rcases &
                        +ncases_new_ndate_ncountry(ndate_ave,ncountry)
                END DO
                fg(ndate,2)=LOG10(MAX(1.0D0,rcases/7.D0))
             END DO
          END SELECT
          title='@'//country_id_ncountry(ncountry)//': '// &
               TRIM(country_name_ncountry(ncountry))//': '// &
                ...
                DO ndate=7,ndate_max
                   ...
                   DO ndate_ave=ndate-6,ndate
                      rcases=rcases &
                           +ncases_new_ndate_ncountry(ndate_ave,ncountry)
                   END DO
                   fg(ndate,nplot)=LOG10(MAX(1.0D0,rcases/7.D0))
                END DO
             END DO
          END SELECT
          title=''
       ...
       IF(nplot_max.EQ.1) THEN
          ...
          CASE(9)
             DO ndate=1,6
                ...
                fg(ndate,1)=LOG10(MAX(1.0D0,rdeaths))
                fg(ndate,2)=LOG10(1.0D0)
             END DO
             DO ndate=7,ndate_max
                rdeaths=ndeaths_new_ndate_ncountry(ndate,ncountry)
                ...
                DO ndate_ave=ndate-6,ndate
                   rdeaths=rdeaths &
                        +ndeaths_new_ndate_ncountry(ndate_ave,ncountry)
                END DO
                fg(ndate,2)=LOG10(MAX(1.0D0,rdeaths/7.D0))
             END DO
          END SELECT
          title='@'//country_id_ncountry(ncountry)//': '// &
               TRIM(country_name_ncountry(ncountry))//': '// &
               region_id_ncountry(ncountry)//': '// &
               'new deaths (7days ave)@'
       ELSE
          ndata=nplot_max
          IF(ALLOCATED(fg)) DEALLOCATE(fg)
          ALLOCATE(fg(ndate_max,ndata))
                ...
                DO ndate=7,ndate_max
                   ...
                   DO ndate_ave=ndate-6,ndate
                      rdeaths=rdeaths &
                           +ndeaths_new_ndate_ncountry(ndate_ave,ncountry)
                   END DO
                   fg(ndate,nplot)=LOG10(MAX(1.D0,rdeaths/7.D0))
                END DO
             END DO
          END SELECT
          title=''
       ...
       DO nplot=1,nplot_max
          ...
          CASE(6)
             DO ndate=1,ndate_max
                rcases=ncases_total_ndate_ncountry(ndate,ncountry) &
                     /population_ncountry(ncountry)
                fg(ndate,nplot)=LOG10(MAX(0.01D0,rcases))
             END DO
          END SELECT
       END DO
       IF(nplot_max.EQ.1) THEN
       ...
       DO nplot=1,nplot_max
          ...
          CASE(7)
             DO ndate=1,ndate_max
                rdeaths=ndeaths_total_ndate_ncountry(ndate,ncountry) &
                     /population_ncountry(ncountry)
                fg(ndate,nplot)=LOG10(MAX(0.01D0,rdeaths))
             END DO
          END SELECT
       END DO
       IF(nplot_max.EQ.1) THEN
       ...
       IF(nplot_max.EQ.1) THEN
          ...
          CASE(8)
             DO ndate=1,6
                rcases=ncases_new_ndate_ncountry(ndate,ncountry) &
                     /population_ncountry(ncountry)
                fg(ndate,1)=LOG10(MAX(0.01D0,rcases))
                fg(ndate,2)=LOG10(0.01D0)
             END DO
             DO ndate=7,ndate_max
                rcases=ncases_new_ndate_ncountry(ndate,ncountry) &
                     /population_ncountry(ncountry)
                ...
                fg(ndate,2)=LOG10(MAX(0.01D0,rcases/7.D0))
             END DO
          END SELECT
          title='@'//country_id_ncountry(ncountry)//': '// &
               TRIM(country_name_ncountry(ncountry))//': '// &
          ...
          CASE(8)
             DO nplot=1,nplot_max
                ...
                DO ndate=7,ndate_max
                   ...
                   END DO
                   rcases=rcases/population_ncountry(ncountry)
                   fg(ndate,nplot)=LOG10(MAX(0.01D0,rcases/7.D0))
                END DO
             END DO
          END SELECT
          title=''
       ...
       IF(nplot_max.EQ.1) THEN
          ...
          CASE(9)
             ...
             DO ndate=7,ndate_max
                ...
                fg(ndate,2)=LOG10(MAX(0.01D0,rdeaths/7.D0))
             END DO
          END SELECT
          title='@'//country_id_ncountry(ncountry)//': '// &
               TRIM(country_name_ncountry(ncountry))//': '// &
          ...
          CASE(9)
             DO nplot=1,nplot_max
                ...
                DO ndate=7,ndate_max
                   ...
                   END DO
                   rdeaths=rdeaths/population_ncountry(ncountry)
                   fg(ndate,nplot)=LOG10(MAX(0.01D0,rdeaths/7.D0))
                END DO
             END DO
          END SELECT
          title=''
