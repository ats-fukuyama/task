...
CONTAINS
  ...
  SUBROUTINE DEFTABY(A,B,FUNC,KID,H0,EPS,ILST,CS,ES)
    IMPLICIT NONE
...
CONTAINS
  ...
  FUNCTION FUNCA(X)
    ...
    ILST=0
    gamma_=X
    CALL DEFTABY(0.D0,gamma_,FUNC1,'FUNC1',H0,EPS,ILST,CS,ES)
    FUNCA=CS
  END FUNCTION FUNCA
  ...
  FUNCTION FUNCB(X)
    ...
    ILST=0
    gamma_=X
    CALL DEFTABY(0.D0,gamma_,FUNC2,'FUNC2',H0,EPS,ILST,CS,ES)
    FUNCB=CS
  END FUNCTION FUNCB
