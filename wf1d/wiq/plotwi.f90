...
CONTAINS
  ...
  SUBROUTINE DEFTABX(A,B,FUNC,KID,H0,EPS,ILST,CS,ES)
    IMPLICIT NONE
...
CONTAINS
  ...
  FUNCTION FUNCA(X)
    ...
    ILST=0
    GAMMA_=X
    CALL DEFTABX(0.D0,GAMMA_,FUNC1,'FUNC1',H0,EPS,ILST,CS,ES)
    FUNCA=CS
  END FUNCTION FUNCA
  ...
  FUNCTION FUNCB(X)
    ...
    ILST=0
    GAMMA_=X
    CALL DEFTABX(0.D0,GAMMA_,FUNC2,'FUNC2',H0,EPS,ILST,CS,ES)
    FUNCB=CS
  END FUNCTION FUNCB
