...
!     ****** COUTOUR PLOT ROUTINE ******
  ...
  SUBROUTINE CONTOUR(XPLOT,YPLOT,FUNC,ITOP,MTITLE,NCON,IVAR)
    ...
    REAL(4):: GXMIN,GXMAX,GYMIN,GYMAX,GRLEN,GZLEN,GPT,GPZ,GDELF
...
!     ****** CALCULATE R,Z VALUE ******
  ...
  SUBROUTINE TOTZ(NTHMAX_L,NRMAX_L,KZ,XM,XN,R,Z,RMNC,ZMNS)
    ...
    USE wmcomm
    USE vmcomm,ONLY: NSRMAX,MNMAX,MN0,NTOR0,HS,OHS,DNORM,RC
    IMPLICIT NONE
    ...
    INTEGER:: KT,J,NTOT,N,NR,JES,MES,MN,L,M,IARG
