...
!     ****** COUTOUR PLOT ROUTINE ******
  ...
  SUBROUTINE CONTOUR(XPLOT,YPLOT,FUNC,ITOP,MTITLE,NCON,IVAR)
    ...
    REAL(4),ALLOCATABLE:: GXPLOT(:),GYPLOT(:),GRTHET(:),GZTHET(:)
    REAL(4),ALLOCATABLE:: GFUNC(:,:),GR1(:),GZ1(:)
    ...
    REAL(4):: GXMIN,GXMAX,GYMIN,GYMAX,GRLEN,GZLEN,GPZ,GDELF
    REAL(4):: GXSMIN,GXSMAX,GYSMIN,GYSMAX,GPR,GXSTP,GYSTP,GFMIN
    EXTERNAL:: PAGES,MOVE,TEXTX,GQSCAL,GNUMBD,TEXT,PAGEE
...
!     ****** CALCULATE R,Z VALUE ******
  ...
  SUBROUTINE TOTZ(NTHMAX_L,NRMAX_L,KZ,XM,XN,R,Z,RMNC,ZMNS)
    ...
    USE wmcomm
    USE vmcomm,ONLY: MNMAX,HS,OHS,DNORM,RC
    IMPLICIT NONE
