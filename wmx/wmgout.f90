...
! ****** DRAW LINES OF 1D GRAPH ******
  ...
  SUBROUTINE wm_gsub(NX,GX,GXMIN,GXMAX,GY,NY,GP,KTITL)
    ...
    REAL(sp),INTENT(IN):: GX(NX),GXMIN,GXMAX,GY(NX,NY),GP(4)
    CHARACTER(LEN=6):: KTITL*6
    INTEGER:: I
    REAL(sp):: GYMIN,GYMAX,GYMIN1,GYMAX1,GSYMIN,GSYMAX,GSX,GSY
...
!     ****** DRAW LINES OF 1D GRAPH ******
  ...
  SUBROUTINE wm_gn1d(NX,GX,GXMIN,GXMAX,GY1,GY2,NY,GP,KTITL)
    ...
    IMPLICIT NONE
    INTEGER,INTENT(IN):: NX,NY
    REAL(sp),INTENT(IN):: GX(NX),GXMIN,GXMAX,GY1(NX,NY),GY2(NX,NY),GP(4)
    CHARACTER(LEN=6),INTENT(IN):: KTITL
    INTEGER:: I
    REAL(sp):: GXL,GYMIN,GYMAX,GYMIN1,GYMAX1,GSX,GSYMIN,GSYMAX,GSY
    REAL(sp):: GYMIN2,GYMAX2
...
! ****** DRAW 2D POLOIDAL GRAPH ******
  ...
  SUBROUTINE wm_grth(K2,K3,K4)
    ...
    REAL(sp):: GRMIN,GRMAX,GZ1MIN,GZ1MAX,GZMIN,GZMAX,GZSTEP
    COMPLEX(rkind):: CFL
...
!     ****** DRAW GRAPH OF MULTIPLE LINES ******
  ...
  SUBROUTINE wm_gcon(GZL,K2,K3,K4,NX)
    ...
    USE wmcomm
    IMPLICIT NONE
    REAL(sp),INTENT(IN):: GZL(nrmax+1,nthmax+1)
    INTEGER,INTENT(IN):: NX
    CHARACTER(LEN=1),INTENT(IN):: K2,K3,K4
    REAL(sp),ALLOCATABLE:: GY(:)
    INTEGER:: MD,MDX,NR,NRLCFS,NSTEP
    REAL(sp):: GXMIN,GXMAX,GYMIN,GYMAX,GZMIN,GZMAX,GZSTEP
    REAL(sp):: GSXMIN,GSXMAX,GSX,GSYMIN,GSYMAX,GSY,GSZMIN,GSZMAX,GSZ
