...
!     ****** DRAW 1D GRAPH ******
  ...
  SUBROUTINE wm_gr1d(K2,K3)
    ...
    REAL(4),ALLOCATABLE:: GX1(:),GX2(:),GYS(:,:),GY(:,:),GY1(:,:),GY2(:,:)
...
!     ****** DRAW LINES OF 1D GRAPH ******
  ...
  SUBROUTINE wm_gn1d(NX,GX,GXMIN,GXMAX,GY1,GY2,NY,GP,KTITL)
    ...
    REAL(4),INTENT(IN):: GX(NX),GXMIN,GXMAX,GY1(NX,NY),GY2(NX,NY),GP(4)
    CHARACTER(LEN=6),INTENT(IN):: KTITL
    INTEGER:: I
    REAL(4):: GXL,GYMIN,GYMAX,GYMIN1,GYMAX1,GSX,GSYMIN,GSYMAX,GSY
    REAL(4):: GYMIN2,GYMAX2
...
! ****** DRAW 2D POLOIDAL GRAPH ******
  ...
  SUBROUTINE wm_grth(K2,K3,K4)
    ...
    REAL(4),ALLOCATABLE:: GXR(:),GY(:,:)
    INTEGER:: NA3,NG3,NHH,NTH,NR,NX,I,NSTEP
    REAL(4):: GRMIN,GRMAX,GZ1MIN,GZ1MAX,GZMIN,GZMAX,GZSTEP
    COMPLEX(rkind):: CFL
...
!     ****** DRAW GRAPH OF MULTIPLE LINES ******
  ...
  SUBROUTINE wm_gcon(GZL,K2,K3,K4,NX)
    ...
    USE wmcomm
    IMPLICIT NONE
    REAL(4),INTENT(IN):: GZL(nrmax+1,nthmax+1)
    INTEGER,INTENT(IN):: NX
    CHARACTER(LEN=1),INTENT(IN):: K2,K3,K4
    REAL(4),ALLOCATABLE:: GY(:)
    INTEGER:: MD,MDX,NR,NRLCFS,NSTEP
    REAL(4):: GXMIN,GXMAX,GYMIN,GYMAX,GZMIN,GZMAX,GZSTEP
    REAL(4):: GSXMIN,GSXMAX,GSX,GSYMIN,GSYMAX,GSY,GSZMIN,GSZMAX,GSZ
