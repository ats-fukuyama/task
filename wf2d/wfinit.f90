...
!        NJMAX : Number of primary grid points of antenna
    ...
    MODELWG=1         ! X,Y  :  0: step function, 1: gaussian
                      ! TH :  5: step function, 6: gaussian
                      ! X,Y  : 12: read file
                      ! R,TH : 15: read file
    R1WG=0.5D0
    Z1WG=0.0D0
    ...
    th_wg_min=-20.D0
    th_wg_max= 20.D0
    phase_wg_min=0.D0  ! phase at th_wg_min
    phase_wg_cen=0.D0  ! phase at (th_wg_min+th_wg_max)/2
    phase_wg_max=0.D0  ! phase at th_wg_max
    ...
    gauss_wg=4.D0      ! amplitude gauss factor EXP(-gauss*x**2)
...
!     *** LOAD FILE NAME ***
    ...
    ! *** debug selection ***
    !        0: main,menu,init,parm,view,broadcast
    !       10: mesh creation
    !       20: mesh preparation
    !       30: antanna
    !       40: waveguid
