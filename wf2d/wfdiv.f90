...
13          CONTINUE
           write(6,'(A,5F10.4)') &
                '## DIV:   rr,rmin,rmax,thmin,thmax = ',&
                rr,rmin_div,rmax_div,thmin_div,thmax_div
           write(6,'(A)') &
                '## INPUT: rr,rmin,rmax,thmin,thmax ? '
           read(5,*,ERR=13,END=2) &
                rr,rmin_div,rmax_div,thmin_div,thmax_div
           write(6,'(A,5F10.4)') &
                '## DIV:   rr,rmin,rmax,thmin,yth_ax = ',&
                rr,rmin_div,rmax_div,thmin_div,thmax_div
14         CONTINUE
           write(6,'(A,2F10.4)') &
        ...
        CASE('L')
31         CONTINUE
           WRITE(6,'(A,A)') '## Layers: layers align in X or Y?: '
