...
MODULE libgrf
  ...
  USE grfutils,ONLY: grfut1,grfut2,grfut3,grfut4,setrgba
...
CONTAINS
  ...
  SUBROUTINE GRF2DA(NGP,GX,GY,GZ,NXM,NXMAX,NYMAX,STR,MODE_LS,IPRD)
    ...
    REAL(4),INTENT(IN):: GX(NXMAX),GY(NYMAX),GZ(NXM,NYMAX)
  ...
  SUBROUTINE GRF2DAX(GP, &
    ...
    REAL(4),INTENT(IN):: GP(4),GX(NXMAX),GY(NYMAX),GZ(NXM,NYMAX)
    REAL(4),INTENT(IN):: GXMIN,GXMAX,GXSTEP,GXORG
    REAL(4),INTENT(IN):: GYMIN,GYMAX,GYSTEP,GYORG
    REAL(4),INTENT(IN):: GFMIN,GFMAX,GFSTEP,GFORG
    CHARACTER(LEN=*),INTENT(IN):: STR
    REAL(4),DIMENSION(:),ALLOCATABLE:: LINE_VALUE
  ...
  SUBROUTINE GRF2DBX(GP, &
    ...
    REAL(4),INTENT(IN):: GP(4),GX(NXMAX),GY(NYMAX),GZ(NXM,NYMAX),GP3D(6)
    REAL(4),INTENT(IN):: GXMIN,GXMAX,GXSTEP,GXORG
    REAL(4),INTENT(IN):: GYMIN,GYMAX,GYSTEP,GYORG
    REAL(4),INTENT(IN):: GFMIN,GFMAX,GFSTEP,GFORG
    CHARACTER(LEN=*),INTENT(IN):: STR
    ...
    CALL GRF2D(NGP,GX,GY,GZ,NXM,NXMAX,NYMAX,STR,MODE_2D=4, &
               ...
               BEV_XLEN=GP(1),BEV_YLEN=GP(2),BEV_ZLEN=GP(3), &
               BEV_PHI=GP(4),BEV_CHI=GP(5),BEV_DISTANCE=GP(6))
  ...
  SUBROUTINE GRF2DCX(GP, &
    ...
    REAL(4),INTENT(IN):: GFMIN,GFMAX,GFSTEP,GFORG
    CHARACTER(LEN=*),INTENT(IN):: STR
    REAL(4),DIMENSION(:),ALLOCATABLE:: PAINT_VALUE
    INTEGER:: N,N1,N2,NMAX,NGP
