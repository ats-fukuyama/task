...
MODULE libbnd
  ...
  PRIVATE
  PUBLIC bandrd,bandcd,bandrdu,bandcdu,bandrq,bandcq
...
!          NOTICE: ARRAY A AND X WILL BE DESTROYED.
 ...
 9002 IERR = 30000+I
      ...
      SUBROUTINE BANDRQ( A , X , N , L , LA , IERR )
...
!          NOTICE: ARRAY A AND X WILL BE DESTROYED.
      ...
      IMPLICIT NONE
      INTEGER,               INTENT(IN)    :: N, L, LA
      REAL(qkind), DIMENSION(LA, N),INTENT(INOUT) :: A
      REAL(qkind), DIMENSION(N),    INTENT(INOUT) :: X
      INTEGER,               INTENT(OUT)   :: IERR
      REAL(qkind)            :: ABS1, ABS2, TEMP
      REAL(qkind), PARAMETER :: EPS = 1.D-70
      INTEGER         :: I, J, K, LH, LHM, NM, LHMK, NPMK, LPMI, IPIVOT, IP, JJ
...
!         WRITE(6,'(A,I8,3ES12.4)') 'A(1,N),EPS=',N,A(1,N),EPS
 ...
 9002 IERR = 30000+I
      RETURN
      END SUBROUTINE BANDRQ

!----- complex version ----

      SUBROUTINE BANDCQ( A , X , N , L , LA , IERR )
...
!          NOTICE: ARRAY A AND X WILL BE DESTROYED.
      ...
      IMPLICIT NONE
      INTEGER,               INTENT(IN)    :: N, L, LA
      COMPLEX(qkind), DIMENSION(LA, N),INTENT(INOUT) :: A
      COMPLEX(qkind), DIMENSION(N),    INTENT(INOUT) :: X
      INTEGER,               INTENT(OUT)   :: IERR
      REAL(qkind) :: ABS1, ABS2
      COMPLEX(qkind) :: TEMP
      REAL(qkind), PARAMETER :: EPS = 1.D-70
      INTEGER :: I, J, K, LH, LHM, NM, LHMK, NPMK, LPMI, IPIVOT, IP, JJ
