...
C
      ...
      DIMENSION GY(NYM),GE(NXM,NYM,3),KA(8,NXM,NYM)
      CHARACTER STR*80
C
      CALL GSOPEN
C
...
C
         MODEG=0
         CALL PAGES
         CALL GRF2DC(0,GX,GY,GE(1,1,1),NXM,NXMAX,NYMAX,STR,KA,MODEG)
         CALL PAGEE
         CALL PAGES
         CALL GRF2DB(0,GX,GY,GE(1,1,1),NXM,NXMAX,NYMAX,STR)
         CALL PAGEE
         CALL PAGES
         CALL GRF2DC(0,GX,GY,GE(1,1,2),NXM,NXMAX,NYMAX,STR,KA,MODEG)
         CALL PAGEE
         CALL PAGES
         CALL GRF2DC(0,GX,GY,GE(1,1,3),NXM,NXMAX,NYMAX,STR,KA,MODEG)
         CALL PAGEE
      ENDIF
      GOTO 1
C
