...
!***********************************************************************
      ...
      REAL(dp),DIMENSION(NA,NL),INTENT(INOUT):: AL
      INTEGER,DIMENSION(NA,NL),INTENT(INOUT):: LL
      REAL(dp),DIMENSION(N),INTENT(INOUT):: D
      REAL(dp),DIMENSION(N),INTENT(IN):: BIN,XIN
      REAL(dp),DIMENSION(N),INTENT(OUT):: XOUt
      REAL(dp),DIMENSION(N+N2):: X
      INTEGER,INTENT(OUT):: ITROUT,IER
      REAL(dp),INTENT(OUT):: EPSOUT
      REAL(dp),DIMENSION(N):: B
      REAL(dp),DIMENSION(N+N2):: DD,TEMP
      REAL(dp),DIMENSION(N+N2,5):: WK
      INTEGER:: I,J,K,ITR
      REAL(dp):: PARM,BN,C1,RQ,ALP,AMU,SS,RN,ERR,BETA,EPS
...
!*    PLU DECOMPOSITION.
      ...
      REAL(dp),INTENT(IN):: PARM
      INTEGER,DIMENSION(NA,NL),INTENT(INOUT):: LL
      REAL(dp),DIMENSION(NA,NL),INTENT(INOUT):: AL
      REAL(dp),DIMENSION(N),INTENT(INOUT):: D,B
      REAL(dp),DIMENSION(N+N2),INTENT(INOUT):: W
...
!*    Y=A*X.
      ...
      REAL(dp),DIMENSION(NA,NL),INTENT(IN):: AL
      REAL(dp),DIMENSION(N),INTENT(IN):: D
      REAL(dp),DIMENSION(N+N2),INTENT(IN):: X
      REAL(dp),DIMENSION(N+N2),INTENT(OUT):: Y
      INTEGER:: I,J
...
!*    Q=PM*P
      ...
      INTEGER,DIMENSION(NA,NL),INTENT(IN):: LL
      REAL(dp),DIMENSION(NA,NL),INTENT(IN):: AL
      REAL(dp),DIMENSION(N+N2),INTENT(IN):: P
      REAL(dp),DIMENSION(N+N2),INTENT(OUT):: W,Q
