...
c NeededBLAS for module ZGEEV from package LAPACK.
c Retrieved from CAMSUN on Tue Nov 23 11:42:37 1999.
c ======================================================================
 
c BLAS REQUIRED BY LAPACK ROUTINE: zgeev
c -----------------------------------------------------------
c Note: Link to BLAS optimized for your system, if available.
c -----------------------------------------------------------
...
* Retrieved from NETLIB on Tue Nov 23 11:43:45 1999.
* ======================================================================
...
*     ..
*     .. Array Arguments ..
      DOUBLE COMPLEX     H( LDH, * ), W( * ), WORK( * ), Z( LDZ, * )
*     ..
*
*  Purpose
*  =======
...
*     .. Local Scalars ..
     ...
     $                   MAXB, NH, NR, NS, NV
      ...
      DOUBLE COMPLEX     CDUM, TAU, TEMP
*     ..
*     .. Local Arrays ..
      DOUBLE PRECISION   RWORK( 1 )
      DOUBLE COMPLEX     S( LDS, NSMAX ), V( NSMAX+1 ), VV( NSMAX+1 )
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*     .. Local Scalars ..
      ...
      DOUBLE COMPLEX     CDUM, H11, H11S, H22, SUM, T, T1, TEMP, U, V2,
     $                   X, Y
*     ..
*     .. Local Arrays ..
      DOUBLE PRECISION   RWORK( 1 )
...
*     ..
*     .. Array Arguments ..
      DOUBLE COMPLEX     A( LDA, * ), T( LDT, NB ), TAU( NB ),
     $                   Y( LDY, NB )
*     ..
*
*  Purpose
...
*     ..
*     .. Array Arguments ..
      DOUBLE COMPLEX     C( LDC, * ), T( LDT, * ), V( LDV, * ),
     $                   WORK( LDWORK, * )
*     ..
*
*  Purpose
...
*     ..
*     .. Array Arguments ..
      DOUBLE COMPLEX     T( LDT, * ), TAU( * ), V( LDV, * )
*     ..
*
*  Purpose
*  =======
...
*     .. Local Scalars ..
      INTEGER            J
      DOUBLE COMPLEX     SUM, T1, T10, T2, T3, T4, T5, T6, T7, T8, T9,
...
*     .. Local Scalars ..
     ...
     $                   XBND, XJ, XMAX
      DOUBLE COMPLEX     CSUMJ, TJJS, USCAL, ZDUM
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            IDAMAX, IZAMAX
      DOUBLE PRECISION   DLAMCH, DZASUM
      DOUBLE COMPLEX     ZDOTC, ZDOTU, ZLADIV
...
*     .. Array Arguments ..
      LOGICAL            SELECT( * )
      DOUBLE PRECISION   RWORK( * )
      DOUBLE COMPLEX     T( LDT, * ), VL( LDVL, * ), VR( LDVR, * ),
     $                   WORK( * )
*     ..
*
*  Purpose
