...
!     ***** PLASMA DISPERSION FUNCTION *****
  ...
  SUBROUTINE DSPFNV(X,Z,DZ,DDZ,DDDZ)
    ...
    COMPLEX(dp),INTENT(OUT):: Z,DZ,DDZ,DDDZ
    COMPLEX(dp):: XA(1),ZA(1),DZA(1),DDZA(1),DDDZA(1)
    XA(1)=X
...
!     ***** PLASMA DISPERSION FUNCTION *****
  ...
  SUBROUTINE DSPFN(X,Z,DZ)
    IMPLICIT NONE
    COMPLEX(dp),INTENT(IN):: X
    COMPLEX(dp),INTENT(OUT):: Z,DZ
    COMPLEX(dp):: XA(1),ZA(1),DZA(1)
    XA(1)=X
