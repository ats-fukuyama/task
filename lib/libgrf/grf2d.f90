...
! ***** DRAW 2D GRAPH *****
  ...
  SUBROUTINE GRF2D(NGP,GX,GY,GF,NXM,NXMAX,NYMAX, &   ! indispensable arguments
    ...
    REAL,INTENT(IN):: GX(NXMAX),GY(NYMAX)       ! 1D data
    REAL,INTENT(IN):: GF(NXM,NYMAX)             ! 1D data
    ...
    CALL GRF_CONVERT(NGP,GX,GY,GF,NXM,NXMAX,NYMAX, &
