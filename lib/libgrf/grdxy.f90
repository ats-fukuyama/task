...
! ***** DRAW 2D trajectory *****
  ...
  SUBROUTINE GRDXY(NGP,FX,FY,FD,NXMAX,NYMAX, &
    ...
    INTEGER,INTENT(IN):: NXMAX,NYMAX               ! Number of axis data
    INTEGER,INTENT(IN):: NDIM,NTM,NDMAX            ! Number of data
    REAL(8),INTENT(IN):: FX(NXMAX),FY(NYMAX)       ! x and y axis data
    ...
    IF(A%MODE_2D.GE.21) THEN
       CALL GRFXY_EXEC(GX,GY,GD,NXMAX,NYMAX,NDIM,NTM,NTMAX,NDMAX,A, &
