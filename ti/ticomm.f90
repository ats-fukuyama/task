...
!     ****** SOURCE VARIABLES ******
    ...
    ALLOCATE(PNB(nsa_max,NRMAX),STAT=IERR); id=21;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SNB(nsa_max,NRMAX),STAT=IERR); id=22;IF(IERR.NE.0) GOTO 900
    ALLOCATE(AJNB(nsa_max,NRMAX),STAT=IERR); id=23;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PEC(nsa_max,NRMAX),STAT=IERR); id=24;IF(IERR.NE.0) GOTO 900
    ALLOCATE(AJEC(nsa_max,NRMAX),STAT=IERR); id=15;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PLH(nsa_max,NRMAX),STAT=IERR); id=26;IF(IERR.NE.0) GOTO 900
    ALLOCATE(AJLH(nsa_max,NRMAX),STAT=IERR); id=27;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PIC(nsa_max,NRMAX),STAT=IERR); id=28;IF(IERR.NE.0) GOTO 900
    ALLOCATE(AJIC(nsa_max,NRMAX),STAT=IERR); id=29;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PNF(nsa_max,NRMAX),STAT=IERR); id=30;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SNF(nsa_max,NRMAX),STAT=IERR); id=31;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SPEL(nsa_max,NRMAX),STAT=IERR); id=32;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SPSC(nsa_max,NRMAX),STAT=IERR); id=33;IF(IERR.NE.0) GOTO 900
    ALLOCATE(POH(nsa_max,NRMAX),STAT=IERR); id=34;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PRB(nsa_max,NRMAX),STAT=IERR); id=35;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PRC(nsa_max,NRMAX),STAT=IERR); id=36;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PRL(nsa_max,NRMAX),STAT=IERR); id=37;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PCX(nsa_max,NRMAX),STAT=IERR); id=38;IF(IERR.NE.0) GOTO 900
    ALLOCATE(PIE(nsa_max,NRMAX),STAT=IERR); id=39;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SCX(nsa_max,NRMAX),STAT=IERR); id=40;IF(IERR.NE.0) GOTO 900
    ALLOCATE(SIE(nsa_max,NRMAX),STAT=IERR); id=41;IF(IERR.NE.0) GOTO 900
    ALLOCATE(AJBS(nsa_max,NRMAX),STAT=IERR); id=42;IF(IERR.NE.0) GOTO 900
