...
! --- recombination
  ...
  SUBROUTINE ADAS_acd(NPA,NZ,PN,PT,DR,IERR)

    USE ADF11
    IMPLICIT NONE
    INTEGER,INTENT(IN):: NPA,NZ
...
! --- ionization
  ...
  SUBROUTINE ADAS_scd(NPA,NZ,PN,PT,DR,IERR)
...
! --- CX recombination
  ...
  SUBROUTINE ADAS_ccd(NPA,NZ,PN,PT,DR,IERR)
...
! --- recombination/bremsstrahlung power
  ...
  SUBROUTINE ADAS_prb(NPA,NZ,PN,PT,DR,IERR)
...
! --- CX power
  ...
  SUBROUTINE ADAS_prc(NPA,NZ,PN,PT,DR,IERR)
...
! --- low level line power
  ...
  SUBROUTINE ADAS_plt(NPA,NZ,PN,PT,DR,IERR)
