...
! ***** DRAW 2D GRAPH *****
  ...
  SUBROUTINE GRF2DP_EXEC(GX,GY,GF,NFMAX,A,LINE_RGB_SUB,MARK_RGB_SUB)
    ...
    END INTERFACE
       ...
       CASE(0)
          CALL PLOTG2(GF,GX,GY,A%NXMIN,NFMAX,A%NXSTEP, &
               ...
               A%PAINT_VALUE,A%PAINT_RGB,A%LINE_MARK,A%LINE_MARK_SIZE, &
               A%LINE_MARK_STEP,A%NPMAX,A%MODE_PRD)
       CASE(1)
