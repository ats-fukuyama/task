...
! ***** DRAW 2D GRAPH *****
  ...
  SUBROUTINE GRF2DP(NGP,GX,GY,GF,NFMAX, &   ! indispensable arguments
    ...
    USE grfpconvert, ONLY: grfp_convert
    USE grf2dpexec, ONLY: grf2dp_exec

    IMPLICIT NONE

    INTEGER,INTENT(IN):: NGP                       ! Graph size and postion ID
    REAL(4),INTENT(IN):: GX(NFMAX),GY(NFMAX)       ! 1D data
    REAL(4),INTENT(IN):: GF(NFMAX)                 ! 1D data
    ...
    REAL(4),INTENT(IN),OPTIONAL:: LINE_MARK_THICKNESS(:)
    ...
    CALL GRFP_CONVERT(NGP,GX,GY,GF,NFMAX, &
    ...
    RETURN
  END SUBROUTINE GRF2DP

END MODULE grf2dp_mod
