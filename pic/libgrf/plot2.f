...
C
     ...
     &                  VM,RGBM,MARKM,STEPM,SIZEM,NMMAX,IPRD)
C
      IMPLICIT LOGICAL(L)
C
      EXTERNAL PLOTV1
      ...
      DIMENSION VM(NMMAX),RGBM(3,NMMAX),MARKM(NMMAX),SIZEM(NMMAX)
      INTEGER STEPM(NMMAX)
C
      CALL PLOTG0(Z,X,Y,NFMIN,NFMAX,NFSTEP,
     &                  VL,RGBL,ILN,WLN,NLMAX,
     &                  VM,RGBM,MARKM,STEPM,SIZEM,NMMAX,IPRD,3,PLOTV1)
C
      RETURN
      END
C
...
C
     ...
     &                  VL,RGBL,ILN,WLN,NLMAX,
     &                  VM,RGBM,MARKM,STEPM,SIZEM,NMMAX)
C
      IMPLICIT LOGICAL(L)
...
C
     ...
     &                  VL,RGBL,ILN,WLN,NLMAX,
     &                  VM,RGBM,MARKM,STEPM,SIZEM,NMMAX,2,1,PLOTV2)
C
      RETURN
      END
C
...
C
     ...
     &                  VL,RGBL,ILN,WLN,NLMAX,
     &                  VM,RGBM,MARKM,STEPM,SIZEM,NMMAX,IPRD,INDX,SUBV)
C
      IMPLICIT LOGICAL(L)
      EXTERNAL SUBV
      DIMENSION Z(NFMAX),X(NFMAX),Y(NFMAX)
