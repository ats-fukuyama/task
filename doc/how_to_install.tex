...
\item
  ...
  \begin{itemize}
  \item
    gfortran: \ttype{sudo port install gcc12}
  \item
...
\begin{itemize}
\item
  \emA{macOS major version-up}: e.g. 13.3 \s 14.0
\item
  \emA{Update Xcode}
  \begin{itemize}
  \item
    Use App Store to update Xcode for the new version of macOS
  \end{itemize}
\item
  \emA{Update Command\_Line\_Tools}
  \begin{itemize}
  \item
    \ttype{xcode-select --install}
  \end{itemize}
\item
  ...
  \begin{itemize}
  \item
    Download and install the Macports binary for the new version of
    macOS from https://www.macports.org
  \item
    It may take a few days before the binary for the new
    version of macOS becomes available.
  \item
    Update the installed ports for the new Macports binary
    \begin{itemize}
    \item
      \ttype{sudo port selfupdate}
    \item
...
\begin{itemize}
\item
\emA{Use the latest develop branch and setup files, make.header and make.mtxp}
\begin{itemize}
\item
\emBs{cd task}
\item
...
\item
  Single processing with MPI: \emBs{make.mtxp.mpi}
\item
...
\end{itemize}
\item
  \emA{Module using parallel matrix solver}
  \begin{itemize}
  \item
