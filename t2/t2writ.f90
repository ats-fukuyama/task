...
CONTAINS
  ...
  SUBROUTINE T2_WRIT
    ...
    USE T2COMM, ONLY: d2xvec,c10rname
...
1   CONTINUE
    ...
    CASE('1')
       ...
       CALL T2_WRIT_MAIN(d2xvec,0,c10rname)
    CASE('2')
       !CALL T2_WRIT_GPT(20,0,d1guv)
       CALL T2_WRIT_GPT(20,0,d2xvec)
    CASE('3')
       !CALL T2_WRIT_GPT(22,0,d1guv)
       CALL T2_WRIT_GPT(22,0,d2xvec)
    CASE('4')
       CALL T2_NGRA_OUTPUT
    CASE('5')
       CALL T2_VGRA_OUTPUT
...
!  SUBROUTINE T2_WRIT_MAIN(d2xxx,i0tag,c10tag)
!    USE T2COMM,ONLY:&
