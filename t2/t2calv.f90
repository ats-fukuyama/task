...
CONTAINS
  ...
  SUBROUTINE T2CALV_PQ
    ...
    DO i0sidi = 1, i0smax
       ...
       d1pp(i0sidi) = d2xvec_befor(i0vidi+5,i0xid2d)
       d1qr(i0sidi) = d2xvec_befor(i0vidi+6,i0xid2d)
       d1qb(i0sidi) = d2xvec_befor(i0vidi+7,i0xid2d)
       d1qt(i0sidi) = d2xvec_befor(i0vidi+8,i0xid2d)
