...
CONTAINS
  ...
  SUBROUTINE T2COEF_AT_COEF_EB(i_m)
    ...
    USE T2COMM, ONLY:&
         ...
         & FtNF,FpNF,QtNF,QpNF,&
         & EqFbNF,EqFtNF,EqPpNF,EqQbNF,EqQtNF,&
  ...
  !
  !                 LAST UPDATE 2014-06-10 H.Seto
  !
  !---------------------------------------------------------
  SUBROUTINE T2COEF_GT_COEF_EB(i_m)
    
    USE T2COMM,ONLY:&
         & NSMAX,NVMAX,NKMAX,NDMAX,         &
         & NnNF,FbNF,PpNF,QbNF,             &
    ...
    DO i_s = 1, NSMAX
       ...
       j_v = 11 + vOffsetB; i_k =  3 + kOffsetX
       GradTenCoef(2,2,i_k,i_v,j_v,i_m)&
            &                      =  BNCPp7*cncv02A*wbA * PpNF/EqPpNF
       j_v = 13 + vOffsetB; i_k =  1
       GradTenCoef(2,2,i_k,i_v,j_v,i_m)&
            &                      = -BNCPp4*cncv10A     * QbNF/EqPpNF
       j_v = 13 + vOffsetB; i_k =  3 + kOffsetX
       GradTenCoef(2,2,i_k,i_v,j_v,i_m)&
