...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : &
           ...
           BB, BBU, BPU, DR, DT, DVRHOU, KUFDCG, KUFDEV, MDLJQ, MDLXP, MDLNI, &
           ...
           KDIRX, NMCHK, NTAMAX, NTXMAX, NTXMAX1, TMU, TMU1
      IMPLICIT NONE
...
!     *** 2D VALUE ***
     ...
     &          NTAMAX,NTXMAX,RHOA,NRAMAX,NRMAX,TMUMAX,0,ICK,MDLXP,IERR)
      ...
      ZEFFU(1:NTXMAX,1:NRMAX)=1.D0     ! in case of MDLNI=0
      ZEFFU_ORG(1:NTXMAX,1:NRMAX)=1.D0 ! in case of MDLNI=0
     ...
     &          NTAMAX,NTXMAX,RHOA,NRAMAX,NRMAX,TMUMAX,0,ICK,MDLXP,IERR)
      IF(MDLNI.NE.0) ZEFFU(1:NTXMAX,1:NRMAX)=FAT(1:NTXMAX,1:NRMAX)
