...
!                     : 0 for prediction
!                     : 1 USE NI_RATIO. NI_RATIO, which means EP density ratio to bulk density, is const. 
...
!       WRITE(6,*) '      PA,PZ,PN,PNS,PTPR,PTPP,PTS,PU,PUS,'
...
!       WRITE(6,*) '      v_RE,target_zeff,SPITOT,MODEL_EX_READ_Tn, MODEL_DELTA_F_NI_RATIO, FACT_BULK'
...
!       WRITE(6,*) '      DH_RATIO, HHe_RATIO, DT_RATIO, given_zeff, SHOT_NUMBER, EG_PATH, MODEL_DELTA_F_CN'
!       WRITE(6,*) '      MODELS_full, MODELS_bt, MODELS_tt'
...
!       idata(63)=NTH_F1
!       idata(64)=NR_F1
!       idata(65)=MODEL_DELTA_F_NI_RATIO
...
!       idata(71)=MODEL_NF_CS
!       idata(72)=NF_IDMAX
!       idata(73)=OUTPUT_NFID
!       idata(74)=MODEL_DELTA_F_CN
!       idata(75)=MODELS_full
!       idata(76)=MODELS_bt
!       idata(77)=MODELS_tt
...
!       NTH_F1 = idata(63)
!       NR_F1 = idata(64)
!       MODEL_DELTA_F_NI_RATIO=idata(65)
...
!       MODEL_NF_CS=idata(71)
!       NF_IDMAX=idata(72)
!       OUTPUT_NFID=idata(73)
!       MODEL_DELTA_F_CN=idata(74)
!       MODELS_full=idata(75)
!       MODELS_bt=idata(76)
!       MODELS_tt=idata(77)
