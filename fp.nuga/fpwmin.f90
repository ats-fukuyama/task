...
!--------------------------------------------
      ...
      IF(nrank.EQ.0) THEN
         ...
         WRITE(6,'(A,5E14.6,2I5)') 'RAW, RRW, BBW, RFWR, RFWI, NPH0W, NTH0W ',&
              RAW,RRW,BBW,RFWR,RFWI,NPH0W,NTH0W 

         READ(21) ((((CEWV(I,NWTH,NWPH,NWR),I=1,3),NWTH=1,NWTHMAX), &
                      NWPH=1,NWPHMAX), NWR=1,NWRMAX)
         WRITE(6,'(A,6E14.6)') 'CEWV, ', (CEWV(I,NWTHMAX/2,1,NWRMAX/2),I=1,3 )
...
!temporal
      ...
      IF(NWPHMAX.EQ.1) THEN
         DO NWR=1,NWRMAX
            ...
            ENDDO
         ENDDO
         IF(NRANK.eq.0)  WRITE(6,'(A,6E14.6)') 'CEWV2, ', (CEWV(I,NWTHMAX/2,1,NWRMAX/2),I=1,3 )
      ELSE
      ...
      IF(NRANK.eq.0)THEN
         DO NJ=1, 4
            WRITE(*,'(A,I5, 8E14.6)') "UCEW2,", NJ, (UCEW2(NI,NJ,2,2,2),NI=1,4)
         END DO
      END IF
