...
!==================================================
  ...
  !
  ! Main equation is the same form of Brizard(2009, 2010)
  ! For stability of numerical calculations!
  ! --> Using Jacobian Form and some dummy coefficients
  !
  ! ref: Brizard, Orbit-averaged Guiding-center Fokker-Planck Operator
  !       (2009), eq(55)
  !      J. Decker, Brizard et al,Orbit-averaged guiding-center 
  !        Fokker–Planck operator for numerical applications (2010)
  !         eq(26)
  !-------------------------------------------------------
