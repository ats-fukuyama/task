...
! ***********************************************************
  ...
  SUBROUTINE fp_gf_time(STRING,FT)
...
! ***********************************************************
  ...
  SUBROUTINE fp_gf_r1d(STRING,FR)
...
! ***********************************************************
  ...
  SUBROUTINE fp_gf_pr2d(STRING,FG)
...
! ***********************************************************
  ...
  SUBROUTINE fp_gf_pp2d(STRING,FG,MODE)
!
    REAL(rkind),DIMENSION(NTHMAX+1,NPMAX+1,NRMAX+1):: FG
...
9000 RETURN
  END SUBROUTINE fp_gf_pp2d
  
  !-------------------------------------
  
  SUBROUTINE fp_gf_pp2da(STRING,FG,MODE)
