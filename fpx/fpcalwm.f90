...
!-------------------------------------------------------
      ...
      REAL(rkind):: FACT, DWPPS, DWPTS, DWTPS, DWTTS, RHOL
!
...
!      SUBROUTINE FPSUMV(ETA,RSIN,RCOS,P,NR,DWPPS,DWPTS,DWTPS,DWTTS,NSA)
      ...
      REAL(RKIND),INTENT(OUT):: DWPS, DWTS
      REAL(RKIND):: DWPL, DWTL
      REAL(rkind):: RSIN, RCOS, P
...
!
      ...
      REAL(RKIND),INTENT(IN):: RHOL, ETAL, PSIN, PCOS, P
      REAL(RKIND),INTENT(OUT):: DWPL, DWTL
      PARAMETER(NJMAX=100)
      ...
      COMPLEX(8):: CTHETA
      REAL(RKIND):: A11, A12, A21, A22, DWC, EX
      REAL(rkind):: RTHETA2
