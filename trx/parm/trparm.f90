...
!     ****** INPUT NAMELIST ******
      ...
      USE TRCOMM, ONLY : &
           ...
           MDNCLS,MDLWLD,MDLFLX,MDLER,MDCD05, &
           ...
           PELTIM,KNAMEQ,KNAMEQ2,KNAMTR,KFNLOG, &
...
!     ***** INPUT PARAMETER LIST *****
  ...
  601 FORMAT(' ','# &TR : RR,RA,RKAP,RDLT,BB,RIPS,RIPE,RHOA'/ &
             ...
             ' ',8X,'MDEDGE'/ &
             ' ',8X,'MDNCLS,MDLWLD,MDLFLX,MDLER,MDCD05'/ &
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : &
           ...
           SYNCSELF, MDLST, MDLTPF, MDLWLD, MDNCLS, MDNI, MDTC, &
  ...
  612    FORMAT(' ',I2,1PD12.4,0P,F8.3,5F9.4)
      ...
      WRITE(6,604) '       ',0,    'KUFDEV',KUFDEV,'KUFDCG',KUFDCG,'MDNI  ',MDNI
