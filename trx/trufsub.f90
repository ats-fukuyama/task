...
!     *****************************************************
      ...
      USE TRCOMM, ONLY : NTUM,KDIRX,rkind
      IMPLICIT NONE
...
!     *** ROUTINE FOR TEXT ***
      ...
      USE TRCOMM, ONLY : KDIRX,NTUM, rkind
      IMPLICIT NONE
      CHARACTER(LEN=10),INTENT(IN)   :: KFID
      CHARACTER(LEN=80),INTENT(INOUT):: KUFDEV,KUFDCG
...
!     *****************************************************
      ...
      USE TRCOMM, ONLY : KDIRX, NTXMAX, NRMP, NRUM, NTUM, rkind
      USE libitp
      USE libspl1d
      IMPLICIT NONE
      CHARACTER(LEN=10),INTENT(IN):: KFID
...
!     *****************************************************
      ...
      USE TRCOMM, ONLY : KDIRX, NRMP, NRUM, NTUM, rkind
      USE libspl1d
      IMPLICIT NONE
      CHARACTER(LEN=10), INTENT(IN):: KFID
      CHARACTER(LEN=80), INTENT(INOUT):: KUFDEV, KUFDCG
