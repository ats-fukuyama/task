...
!
      ...
      ENDDO
!
!     Line interporate for ECH Power 
!
#ifdef ECH_UFILE_DIRECT
      IF(KFID=='QECH')THEN
           IF(NRMAX==NRLMAX-1)THEN
           print*,'NOW READING ECH files'
           DO NRL=1,NRMAX
             print*,NRL,F2(1,NRL)
             FOUT(NRL)=F2(1,NRL)
           ENDDO
         ELSE
           print*,""
           print*,"========================================"
           print*,"ECH FILE READ ERROR. NRMAX != NRLMAX-1." 
           print*,"NRMAX  :",NRMAX
           print*,"NRLMAX-1 :",NRLMAX-1  
           print*,"========================================"
           stop
         ENDIF
      ENDIF
...
!      REAL(8),DIMENSION(502):: DERIV, TMP
