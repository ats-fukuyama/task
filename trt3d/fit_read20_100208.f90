...
!c   10/02/08    Parallel torque is added.
!c==================================================c
!c
    subroutine ftrd20
...
!c
      open(5,file='prof.in5',status='old')
      open(6,file='prof.out6',status='new')
      open(20,file='prof.out20',status='old')
      open(10,file='prof.out10',status='new')
      open(11,file='prof.out11',status='new')
...
!
      qtei= qe(ir)+qi(ir) 
!
       write(10,'(i4,19e15.5)') ir, r(ir),qtei,qe(ir),qi(ir),qtot,qet,qit &
...
!
      if (deltti.gt.1.d-2) then
         ...
         do  ir=1,np
         write(11,'(i4,19e15.5)') ir, r(ir),qe(ir),qi(ir) &
