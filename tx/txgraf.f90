...
!!$              END DO
  ...
  SUBROUTINE TXSTGR
    ...
    GY(0:NRMAX,NGR,38) = SNGL(X(LQe2,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,39) = SNGL(X(LQe3,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,40) = SNGL(X(LQe4,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,41) = SNGL(X(LQe5,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,42) = SNGL(X(LQi2,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,43) = SNGL(X(LQi3,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,44) = SNGL(X(LQi4,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,45) = SNGL(X(LQi5,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,46) = SNGL(X(LQb3,0:NRMAX)*1.D20)
    GY(0:NRMAX,NGR,47) = SNGL(X(LQb4,0:NRMAX)*1.D20)

    !  Coefficients

    GY(0:NRMAX,NGR,48) = SNGL(rMue(0:NRMAX))
    GY(0:NRMAX,NGR,49) = SNGL(rMui(0:NRMAX))
    GY(0:NRMAX,NGR,50) = SNGL(rNuei(0:NRMAX))
    GY(0:NRMAX,NGR,51) = SNGL(rNuL(0:NRMAX))
    GY(0:NRMAX,NGR,52) = SNGL(rNube(0:NRMAX))
    GY(0:NRMAX,NGR,53) = SNGL(rNubi(0:NRMAX))
    GY(0:NRMAX,NGR,54) = SNGL(FWthe(0:NRMAX))
    GY(0:NRMAX,NGR,55) = SNGL(FWthi(0:NRMAX))
    GY(0:NRMAX,NGR,56) = SNGL(WPM(0:NRMAX))
    GY(0:NRMAX,NGR,57) = SNGL(rNuTei(0:NRMAX))
    GY(0:NRMAX,NGR,58) = SNGL(rNu0e(0:NRMAX))
    GY(0:NRMAX,NGR,59) = SNGL(rNu0i(0:NRMAX))
    GY(0:NRMAX,NGR,60) = SNGL(Chie(0:NRMAX))
    GY(0:NRMAX,NGR,61) = SNGL(Chii(0:NRMAX))
    GY(0:NRMAX,NGR,62) = SNGL(D01(0:NRMAX))
    GY(0:NRMAX,NGR,63) = SNGL(D02(0:NRMAX))
    GY(0:NRMAX,NGR,64) = SNGL(rNueNC(0:NRMAX))
    GY(0:NRMAX,NGR,65) = SNGL(rNuiNC(0:NRMAX))
    GY(0:NRMAX,NGR,66) = SNGL(rNueHL(0:NRMAX))
    GY(0:NRMAX,NGR,67) = SNGL(rNuiHL(0:NRMAX))
    GY(0:NRMAX,NGR,68) = SNGL(rNuiCX(0:NRMAX))
    GY(0:NRMAX,NGR,69) = SNGL(rNuB(0:NRMAX))
    GY(0:NRMAX,NGR,70) = SNGL(rNuION(0:NRMAX))
    GY(0:NRMAX,NGR,71) = SNGL(SiLC(0:NRMAX))
    GY(0:NRMAX,NGR,72) = SNGL(SiLCth(0:NRMAX))
    GY(0:NRMAX,NGR,73) = SNGL(SiLCph(0:NRMAX))
    GY(0:NRMAX,NGR,74) = SNGL(SNB(0:NRMAX))
  ...
  SUBROUTINE TXGRFR(NGYRIN,MODE)
    ...
    CASE(-3)
       ...
       STR = '@LQm5@'
       CALL TXGRFRXS( 4,GX,GY(0,0,18),NRMAX,NGR,STR,MODE,IND)
       ...
       STR = '@LQe2@'
       CALL APPROPGY(MODEG, GY(0,0,38), GYL, STR, NRM, NRMAX, NGR, gDIV(38))
       CALL TXGRFRXS( 6,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQe3@'
       CALL APPROPGY(MODEG, GY(0,0,39), GYL, STR, NRM, NRMAX, NGR, gDIV(39))
       CALL TXGRFRXS( 7,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQe4@'
       CALL APPROPGY(MODEG, GY(0,0,40), GYL, STR, NRM, NRMAX, NGR, gDIV(40))
       CALL TXGRFRXS( 8,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQe5@'
       CALL APPROPGY(MODEG, GY(0,0,41), GYL, STR, NRM, NRMAX, NGR, gDIV(41))
       CALL TXGRFRXS( 9,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQi1@'
       CALL APPROPGY(MODEG, GY(0,0,37), GYL, STR, NRM, NRMAX, NGR, gDIV(37))
       CALL TXGRFRXS(10,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQi2@'
       CALL APPROPGY(MODEG, GY(0,0,42), GYL, STR, NRM, NRMAX, NGR, gDIV(42))
       CALL TXGRFRXS(11,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQi3@'
       CALL APPROPGY(MODEG, GY(0,0,43), GYL, STR, NRM, NRMAX, NGR, gDIV(43))
       CALL TXGRFRXS(12,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQi4@'
       CALL APPROPGY(MODEG, GY(0,0,44), GYL, STR, NRM, NRMAX, NGR, gDIV(44))
       CALL TXGRFRXS(13,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQi5@'
       CALL APPROPGY(MODEG, GY(0,0,45), GYL, STR, NRM, NRMAX, NGR, gDIV(45))
       CALL TXGRFRXS(14,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)
    ...
    CASE(-4)
       STR = '@LQb3@'
       CALL APPROPGY(MODEG, GY(0,0,46), GYL, STR, NRM, NRMAX, NGR, gDIV(46))
       CALL TXGRFRXS( 0,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)

       STR = '@LQb4@'
       CALL APPROPGY(MODEG, GY(0,0,47), GYL, STR, NRM, NRMAX, NGR, gDIV(47))
       CALL TXGRFRXS( 1,GX,GYL       ,NRMAX,NGR,STR,MODE,IND)
    ...
    CASE(-5)
       STR = '@rMue@'
       CALL TXGRFRXS( 0,GX,GY(0,0,48),NRMAX,NGR,STR,MODE,IND)

       STR = '@rMui@'
       CALL TXGRFRXS( 1,GX,GY(0,0,49),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuei@'
       CALL TXGRFRXS( 2,GX,GY(0,0,50),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuL@'
       CALL TXGRFRXS( 3,GX,GY(0,0,51),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNube@'
       CALL TXGRFRXS( 4,GX,GY(0,0,52),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNubi@'
       CALL TXGRFRXS( 5,GX,GY(0,0,53),NRMAX,NGR,STR,MODE,IND)

       STR = '@FWthe@'
       CALL TXGRFRXS( 6,GX,GY(0,0,54),NRMAX,NGR,STR,MODE,IND)

       STR = '@FWthi@'
       CALL TXGRFRXS( 7,GX,GY(0,0,55),NRMAX,NGR,STR,MODE,IND)

       STR = '@WPM@'
       CALL TXGRFRXS( 8,GX,GY(0,0,56),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuTei@'
       CALL TXGRFRXS( 9,GX,GY(0,0,57),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNu0e@'
       CALL TXGRFRXS(10,GX,GY(0,0,58),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNu0i@'
       CALL TXGRFRXS(11,GX,GY(0,0,59),NRMAX,NGR,STR,MODE,IND)

       STR = '@Chie@'
       CALL TXGRFRXS(12,GX,GY(0,0,60),NRMAX,NGR,STR,MODE,IND)

       STR = '@Chii@'
       CALL TXGRFRXS(13,GX,GY(0,0,61),NRMAX,NGR,STR,MODE,IND)

       STR = '@D01@'
       CALL TXGRFRXS(14,GX,GY(0,0,62),NRMAX,NGR,STR,MODE,IND)

       STR = '@D02@'
       CALL TXGRFRXS(15,GX,GY(0,0,63),NRMAX,NGR,STR,MODE,IND)

    CASE(-6)
       STR = '@rNueNC@'
       CALL TXGRFRXS( 0,GX,GY(0,0,64),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuiNC@'
       CALL TXGRFRXS( 1,GX,GY(0,0,65),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNueHL@'
       CALL TXGRFRXS( 2,GX,GY(0,0,66),NRMAX,NGR,STR,MODE,IND)     

       STR = '@rNuiHL@'
       CALL TXGRFRXS( 3,GX,GY(0,0,67),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuiCX@'
       CALL TXGRFRXS( 4,GX,GY(0,0,68),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuION@'
       CALL TXGRFRXS( 5,GX,GY(0,0,69),NRMAX,NGR,STR,MODE,IND)

       STR = '@rNuB@'
       CALL TXGRFRXS( 6,GX,GY(0,0,70),NRMAX,NGR,STR,MODE,IND)     

       STR = '@SiLC@'
       CALL TXGRFRXS( 7,GX,GY(0,0,71),NRMAX,NGR,STR,MODE,IND)

       STR = '@SiLCth@'
       CALL TXGRFRXS( 8,GX,GY(0,0,72),NRMAX,NGR,STR,MODE,IND)

       STR = '@SiLCph@'
       CALL TXGRFRXS( 9,GX,GY(0,0,73),NRMAX,NGR,STR,MODE,IND)     

       STR = '@PRFe@'
       CALL TXGRFRXS(10,GX,GY(0,0,74),NRMAX,NGR,STR,MODE,IND)

       STR = '@PRFi@'
       CALL TXGRFRXS(11,GX,GY(0,0,75),NRMAX,NGR,STR,MODE,IND)

       STR = '@SNB@'
       CALL TXGRFRXS(12,GX,GY(0,0,76),NRMAX,NGR,STR,MODE,IND)
