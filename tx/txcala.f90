...
!***************************************************************
  ...
  SUBROUTINE LQi1CC
    ...
    PELM(1:NEMAX,1:4,7,LQi1) = - RatCX * fem_int(-1,SNBi)
    NLC(7,LQi1) = 0
...
!!oldNBI      NLC( 9,LQi5) = LQb4
       ...
       ELM(1:NEMAX,1:4, 8,LQi5) = AMB * Vb / rKeV * fem_int(28,BthBNi,MNB)
       NLC( 8,LQi5) = LQi3

       ELM(1:NEMAX,1:4, 9,LQi5) = AMB * Vb / rKeV * fem_int(28,BphBNi,MNB)
       NLC( 9,LQi5) = LQi4
