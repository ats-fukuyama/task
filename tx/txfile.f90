...
SUBROUTINE TXSAVE
  use tx_commons, only : SLID,RA,RB,RC,RR,BB,PA,PZ,Zeff,PN0,PNa,PTe0,PTea,PTi0,PTia,PROFJ, &
       ...
       &              MODEG,MODEAV,MODEGL,MDLPCK,MDLWTB,MDLETA,MDFIXT,IDIAG,IGBDF
  ...
  WRITE(21) rNRF,RRF,RRF0,PRFH,PNBCD
  ...
  WRITE(21) MDLETA,MDFIXT,IDIAG,IGBDF
...
SUBROUTINE TXLOAD
  ...
  READ(21) rNRF,RRF,RRF0,PRFH,PNBCD
  ...
  READ(21) MDLETA,MDFIXT,IDIAG,IGBDF
