...
!***************************************************************
  ...
  SUBROUTINE TXSAVE
    ...
    WRITE(21) rLn,rLT
    WRITE(21) Eb,Vb,RNBP,RNBP0,RNBT1,RNBT2,RNBT10,RNBT20,PNBH,PNBHP,PNBHT1,PNBHT2
    WRITE(21) rNRF,RRF,PRFH,PNBCD
...
!***************************************************************
  ...
  SUBROUTINE TXLOAD
    ...
    READ(21) rLn,rLT
    READ(21) Eb,Vb,RNBP,RNBP0,RNBT1,RNBT2,RNBT10,RNBT20,PNBH,PNBHP,PNBHT1,PNBHT2
    READ(21) rNRF,RRF,PRFH,PNBCD
