...
C
      ...
      WRITE(21) (SIGM(NTG),NTG=1,NTGMAX)
      WRITE(21) (THGM(NTG),NTG=1,NTGMAX)
      ...
      WRITE(21) ((UQPV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
      WRITE(21) ((UPSITV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
      WRITE(21) ((UTTV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
...
C
      ...
      READ(21) (SIGM(NTG),NTG=1,NTGMAX)
      READ(21) (THGM(NTG),NTG=1,NTGMAX)
      ...
      READ(21) ((UQPV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
      READ(21) ((UPSITV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
      READ(21) ((UTTV(NA,NRV),NA=1,4),NRV=1,NRVMAX)
