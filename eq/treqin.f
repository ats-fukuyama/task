...
C     &        NTR,RHOTRG(NTR),QRHO(NTR),PSIRHO(NTR)
      ENDDO
C      PAUSE
      PSI0=-PSIRHO(NTRMAX+1)
      DO NTR=1,NTRMAX+1
         PSIRHO(NTR)=PSI0+PSIRHO(NTR)
      ENDDO
C
