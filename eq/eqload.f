...
C
      PARAMETER(KLEN=80)
      CHARACTER*80 KKLINE,KKLINE1
C
      DO 100 I=1,KLEN
         IF(KKLINE(I:I).NE.' ') GOTO 110
  100 CONTINUE
  110 ITOP=I
C
      DO 200 I=KLEN,1,-1
         IF(KKLINE(I:I).NE.' ') GOTO 210
  200 CONTINUE
  210 IBOTTOM=I
C
...
C
      PARAMETER(KLEN=80)
      CHARACTER*80 KKLINE1,KKLINE2
C
      DO 100 I=1,KLEN
         IF(KKLINE1(I:I).NE.KKLINE2(I:I)) GO TO 200
  100 CONTINUE
      KMATCH=.TRUE.
      RETURN
C
