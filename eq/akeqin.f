...
C
      ...
      CALL SPL1DD(PSIL,BBMAXL,DBBMAXL,PSIP,UBBMAX,NRMAX,IERR)
...
C
      ...
      FTL=ALPHA
      CALL SPL1DD(FTL,PSIL,DPSIL,PSIT,UFTT,NRMAX,IERR)
      IF(IERR.NE.0) WRITE(6,*) 'XX SUBBMN: SPL1DD ERROR1 : IERR=',IERR
      CALL SPL1DD(PSIL,BBMINL,DBBMINL,PSIP,UBBMIN,NRMAX,IERR)
...
C
      CALL SPL1DF(SQRT(ALPHA/PSITA),TTL,RHOT,UTTS,NRMAX,IERR)
