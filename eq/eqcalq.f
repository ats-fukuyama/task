...
!      write(17,'(2I5,1P4E12.4)') ((NR,NTH,PSIP(NR),THIT(NTH),
!     &     RPS(NTH,NR),ZPS(NTH,NR),NTH=1,NTHMAX+1),NR=1,NRMAX)
C
      DO NR=1,NRMAX
         RHOTL=RHOT(NR)
         QPSL=FNQPS(RHOTL)
         ...
         DO NTH=1,NTHMAX+1
            THITL=THIT(NTH)
            CALL SPL2DD(THITL,PSIPL,RPSL,DRCHIL,DRPSIL,
     &                  THIT,PSIP,URPS,NTHMP,NTHMAX+1,NRMAX,IERR)
            CALL SPL2DD(THITL,PSIPL,ZPSL,DZCHIL,DZPSIL,
