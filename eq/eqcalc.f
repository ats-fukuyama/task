...
C            write(6,*) TT(NTG,NSG),RHO(NTG,NSG)
      ...
      ELSEIF(MODELF.EQ.1) THEN
         ...
         DO NTG=1,NTGMAX
            ...
            HJP2(NTG,NSG)=HJP1(NTG,NSG)*EXP(OTC*RMM(NTG,NSG)**2*AMP
     &                   /2.D0)
...
C
   ...
   20    WRITE(6,*) 'XX NEW FILE OPEN ERROR : IOSTAT = ',IST
      ...
      ENDIF
C
c$$$   30 WRITE(21) RR,BB,RIP
c$$$      WRITE(21) NRGMAX,NZGMAX
c$$$      WRITE(21) (RG(NRG),NRG=1,NRGMAX)
c$$$      WRITE(21) (ZG(NZG),NZG=1,NZGMAX)
c$$$      WRITE(21) ((PSIRZ(NRG,NZG),NRG=1,NRGMAX),NZG=1,NZGMAX)
 30   WRITE(21) NPSMAX
...
C
c$$$      WRITE(21) NSGMAX,NTGMAX
c$$$      WRITE(21) RA,RKAP,RDLT,RB
c$$$      WRITE(21) PJ0,PJ1,PJ2,PROFJ0,PROFJ1,PROFJ2
c$$$      WRITE(21) PP0,PP1,PP2,PROFP0,PROFP1,PROFP2
c$$$      WRITE(21) PT0,PT1,PT2,PROFT0,PROFT1,PROFT2
c$$$      WRITE(21) PV0,PV1,PV2,PROFV0,PROFV1,PROFV2
c$$$      WRITE(21) PROFR0,PROFR1,PROFR2
c$$$C      WRITE(21) PTS,PN0,HM
      CLOSE(21)
C
