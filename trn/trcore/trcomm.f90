...
! ----- plasma variables -----
  ...
  REAL(rkind),DIMENSION(:),ALLOCATABLE:: &
       ...
       jex   ,   &! externally driven current density on grid [A/m^2]
       ...
       jbs_nc,   &! bootstrap current density on HALF grid [A/m^2]
       jex_nc,   &! externally driven current density on HALF grid [A/m^2]
