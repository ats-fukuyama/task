...
C
      ...
      CALL GVALUE(GXSMN,2*GSCALX,0.0,0.0,NGVLEN(2*GSCALX))
      CALL GVALUE(0.0,0.0,GYSMN,2*GSCALY,NGVLEN(2*GSCALY))
...
C
      ...
      DO NX=1,NXMAX
         ...
         DZ2=MAX(SQRT(DZX**2+DZY**2),1.D0)
         GZ(NX,NY,NGP)=GCLIP(Z(NX,NY,NGP)/DZ2)
      ENDDO
      ENDDO
      ENDDO
C
