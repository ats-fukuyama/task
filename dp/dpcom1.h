...
C
      PARAMETER(NHM=100)
      PARAMETER(NXM=1001)
      PARAMETER(NPM=100,NTHM=100,NRM=25)
      PARAMETER(NGXM=101,NGYM=101)
C
      COMMON /DPPRM1/ MODELP(NSM),NDISP1(NSM),NDISP2(NSM)
      COMMON /DPPRM2/ MODELF
...
C
      COMMON /DPLOC1/ CW,CKPR,CKPP
C
      COMMON /DPFPT1/ NPMAX,NTHMAX,NRMAX
      COMMON /DPFPT2/ DELP,DELTH,DELR
      COMMON /DPFPT3/ FP(NTHM,NPM,0:NRM)
      COMMON /DPFPT4/ RNE0,TE0,PTH0
C
      COMMON /DPFPM1/ FM(NPM,NTHM),DFP(NPM,NTHM),DFT(NPM,NTHM)
      COMMON /DPFPM2/ PM(NPM),PG(NPM),RM(NRM)
...
C
      COMMON /DPFP01/ RHOFP,BMINL
      COMMON /DPFP02/ RFP(NRM+2),URFP(4,NRM+2,NPM,NTHM)
      COMMON /DPFP02/ FPDATA(6),NFPDAT(3)
