...
!     *************************
  ...
  SUBROUTINE DPGRP1
    ...
    REAL:: GXMIN,GXMAX,GXSMN,GXSMX,GSCALX
    REAL:: GYMIN,GYMAX,GYSMN,GYSMX,GSCALY
    REAL:: GUCLIP
    REAL(rkind):: DRFI,RNPHII,DKX,DKY,DKZ
    EXTERNAL PAGES,SETLIN,SETCHS,GMNMX1,GQSCAL,PAGEE
    EXTERNAL GDEFIN,GFRAME,GSCALE,GSCALL,GVALUE,GVALUL,GPLOTP
...
!     *************************
  ...
  SUBROUTINE DP_ROOT
    ...
    USE dppola
    IMPLICIT NONE
    REAL,DIMENSION(:),ALLOCATABLE::  GX,GY,GY2
    REAL,DIMENSION(:,:),ALLOCATABLE:: GXA,GYA,GY2A
...
!     *******************************
  ...
  SUBROUTINE DPGR1A(GX,GY,GY2,NGXMAX,ISW)
    ...
    IMPLICIT NONE
    INTEGER,INTENT(IN):: NGXMAX,ISW
    REAL,INTENT(IN):: GX(NGXMAX),GY(NGXMAX),GY2(NGXMAX)
    REAL:: GXMIN,GXMAX,GYMIN,GYMAX,GXSMN,GXSMX,GSCALX,GYSMN,GYSMX,GSCALY
    REAL:: GXORG,GYORG
    EXTERNAL PAGES,SETLIN,SETCHS,GMNMX1,GQSCAL,PAGEE
    EXTERNAL GDEFIN,GFRAME,GSCALE,GVALUE,GPLOTP
...
!     *******************************
  ...
  SUBROUTINE DPGR1B(GXA,GYA,GY2A,NXM,NGXMAXA,IGMAX,ISW)
    ...
    IMPLICIT NONE
    INTEGER,INTENT(IN):: NXM,IGMAX,ISW
    REAL,INTENT(IN):: GXA(NXM,IGMAX),GYA(NXM,IGMAX),GY2A(NXM,IGMAX)
    INTEGER,INTENT(IN):: NGXMAXA(IGMAX)
    REAL:: GXMIN,GXMAX,GYMIN,GYMAX,GYMIN3,GYMAX3
    REAL:: GXMIN1,GXMAX1,GYMIN1,GYMAX1,GYMIN2,GYMAX2
    REAL:: GXSMN,GXSMX,GSCALX,GYSMN,GYSMX,GSCALY,GXORG,GYORG
    INTEGER:: IG
    EXTERNAL PAGES,SETLIN,SETCHS,GMNMX1,GQSCAL,PAGEE
    EXTERNAL GDEFIN,GFRAME,GSCALE,GVALUE,GPLOTP
...
!     *******************************
  ...
  SUBROUTINE DPGPRM(ISW)
    ...
    EXTERNAL SETLIN,MOVE,TEXT,SETCHS,NUMBD,NUMBI
