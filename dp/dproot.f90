...
!     *******************************
  ...
  SUBROUTINE DPGR1A(GX,GY,GY2,NGXMAX,ISW)
    ...
    REAL(4),INTENT(IN):: GX(NGXMAX),GY(NGXMAX),GY2(NGXMAX)
...
!     *******************************
  ...
  SUBROUTINE DPGR1B(GXA,GYA,GY2A,NXM,NGXMAXA,IGMAX,ISW)
    ...
    REAL(4),INTENT(IN):: GXA(NXM,IGMAX),GYA(NXM,IGMAX),GY2A(NXM,IGMAX)
    INTEGER,INTENT(IN):: NGXMAXA(IGMAX)
    REAL(4):: GXMIN,GXMAX,GYMIN,GYMAX,GYMIN3,GYMAX3
    REAL(4):: GXMIN1,GXMAX1,GYMIN1,GYMAX1,GYMIN2,GYMAX2
    REAL(4):: GXSMN,GXSMX,GSCALX,GYSMN,GYSMX,GSCALY,GXORG,GYORG
    INTEGER:: IG
