...
C
         CDENX=CW-DKPRX+MM*VD*CCHI(NCH2)*0.25D0*AA/RSL
C         CDEN=1.D0/CDENX
C
...
C
         ...
         CINTG112a = CINTG112a + CDEN*CPART11*PI1*DELTH*PTH0*DELP
         CINTG113a = CINTG113a + CDEN*CPART11*PI2*DELTH*PTH0*DELP
         CINTG121a = CINTG121a + CDEN*CPART11*PI1*DELTH*PTH0*DELP
         CINTG122a = CINTG122a + CDEN*CPART11*PI1*DELTH*PTH0*DELP
         CINTG123a = CINTG123a + CDEN*CPART11*PI2*DELTH*PTH0*DELP
         CINTG131a = CINTG131a + CDEN*CPART11*PI2*DELTH*PTH0*DELP
         CINTG132a = CINTG132a + CDEN*CPART11*PI2*DELTH*PTH0*DELP
         CINTG133a = CINTG133a + CDEN*CPART11*PI3*DELTH*PTH0*DELP
C
         CINTG111b = CINTG111b + CDEN*CPART12*PI1*DELTH*PTH0*DELP
         CINTG112b = CINTG112b + CDEN*CPART12*PI1*DELTH*PTH0*DELP
         CINTG113b = CINTG113b + CDEN*CPART12*PI2*DELTH*PTH0*DELP
         CINTG121b = CINTG121b + CDEN*CPART12*PI1*DELTH*PTH0*DELP
         CINTG122b = CINTG122b + CDEN*CPART12*PI1*DELTH*PTH0*DELP
         CINTG123b = CINTG123b + CDEN*CPART12*PI2*DELTH*PTH0*DELP
         CINTG131b = CINTG131b + CDEN*CPART12*PI2*DELTH*PTH0*DELP
         CINTG132b = CINTG132b + CDEN*CPART12*PI2*DELTH*PTH0*DELP
         CINTG133b = CINTG133b + CDEN*CPART12*PI3*DELTH*PTH0*DELP
C
         CINTG111c = CINTG111c + CDEN*CPART13*PI1*DELTH*PTH0*DELP
         CINTG112c = CINTG112c + CDEN*CPART13*PI1*DELTH*PTH0*DELP
         CINTG113c = CINTG113c + CDEN*CPART13*PI2*DELTH*PTH0*DELP
         CINTG121c = CINTG121c + CDEN*CPART13*PI1*DELTH*PTH0*DELP
         CINTG122c = CINTG122c + CDEN*CPART13*PI1*DELTH*PTH0*DELP
         CINTG123c = CINTG123c + CDEN*CPART13*PI2*DELTH*PTH0*DELP
         CINTG131c = CINTG131c + CDEN*CPART13*PI2*DELTH*PTH0*DELP
         CINTG132c = CINTG132c + CDEN*CPART13*PI2*DELTH*PTH0*DELP
...
C
      CINTG111 = (COEA*CINTG111a+COEB*CINTG111b+COEB*CINTG111c)
     &     *CCHI(NCH1)*CCHI(NCH2)
      CINTG112 = (COEA*CINTG112a+COEB*CINTG112b+COEB*CINTG112c)
     &     *CCHI(NCH1)*SCHI(NCH2)
      CINTG113 = (COEA*CINTG113a+COEB*CINTG113b+COEB*CINTG113c)
     &     *CCHI(NCH1)
      CINTG121 = (COEA*CINTG121a+COEB*CINTG121b+COEB*CINTG121c)
     &     *SCHI(NCH1)*CCHI(NCH2)
      CINTG122 = (COEA*CINTG122a+COEB*CINTG122b+COEB*CINTG122c)
     &     *SCHI(NCH1)*SCHI(NCH2)
      CINTG123 = (COEA*CINTG123a+COEB*CINTG123b+COEB*CINTG123c)
     &     *SCHI(NCH1)
      CINTG131 = (COEA*CINTG131a+COEB*CINTG131b+COEB*CINTG131c)
     &     *CCHI(NCH2)
      CINTG132 = (COEA*CINTG132a+COEB*CINTG132b+COEB*CINTG132c)           
     &     *SCHI(NCH2)
      CINTG133 = (COEA*CINTG133a+COEB*CINTG133b+COEB*CINTG133c)
C
C
C*************SUM2********************
C
...
C
         ...
         CINTG212a = CINTG212a + CDEN*CPART2*PI1*DELTH*PTH0*DELP
         CINTG213a = CINTG213a + CDEN*CPART2*PI2*DELTH*PTH0*DELP
         CINTG221a = CINTG221a + CDEN*CPART2*PI1*DELTH*PTH0*DELP
         CINTG222a = CINTG222a + CDEN*CPART2*PI1*DELTH*PTH0*DELP
         CINTG223a = CINTG223a + CDEN*CPART2*PI2*DELTH*PTH0*DELP
         CINTG231a = CINTG231a + CDEN*CPART2*PI2*DELTH*PTH0*DELP
         CINTG232a = CINTG232a + CDEN*CPART2*PI2*DELTH*PTH0*DELP
...
C
      CINTG211 = COED*CINTG211a*CCHI(NCH1)*CCHI(NCH2)
      CINTG212 = COED*CINTG212a*CCHI(NCH1)*SCHI(NCH2)
      CINTG213 = COED*CINTG213a*CCHI(NCH1)
      CINTG221 = COED*CINTG221a*SCHI(NCH1)*CCHI(NCH2)
      CINTG222 = COED*CINTG222a*SCHI(NCH1)*SCHI(NCH2)
      CINTG223 = COED*CINTG223a*SCHI(NCH1)
      CINTG231 = COED*CINTG231a           *CCHI(NCH2)
      CINTG232 = COED*CINTG232a           *SCHI(NCH2)
      CINTG233 = COED*CINTG233a
C
C****************SUM3*********************************
C
      CINTG311a = (0.D0,0.D0)
...
C
      CINTG311a = CINTG311a+EPART1*DELTH*PTH0*DELP
...
C
      CINTG411 = CINTG411+FPART*DELTH*PTH0*DELP
      CINTG422 = CINTG422+FPART*DELTH*PTH0*DELP
C      CINTG433 = CINTG433+FPART
C
      ENDDO
      ENDDO
C
      COEE4 = 2*PI*AE*BABS
C
      CINTG411 = COEE4*CINTG411
      CINTG422 = COEE4*CINTG422
C      CINTG433 = COEE3*CINTG433
C
C*****************************************************
C
      CLDISP(1) = CINTG111+CINTG211+CINTG311
      CLDISP(2) = CINTG112+CINTG212+CINTG411
      CLDISP(3) = CINTG113+CINTG213
      CLDISP(4) = CINTG121+CINTG221+CINTG422
