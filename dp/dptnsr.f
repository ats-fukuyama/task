...
C
      ...
      CFGM=-CPR*(1.D0+(1.D0-1.D0/WTPX))*CGZ(-1)*CDZ(-1)
...
C
      CLDISP(1)=CLDISP(1)-CWP*      CBLAM*CFW
      CLDISP(2)=CLDISP(2)+CWP*     (CLAM*CFG+CBLAM*CFW)
      CLDISP(3)=CLDISP(3)-CWP* 2.D0*CBETA*CDLAM*CFW
      CLDISP(4)=CLDISP(4)-CWP*   CK*CBLAM*CFF
      CLDISP(5)=CLDISP(5)-CWP*CI*   CDLAM*CFW
      CLDISP(6)=CLDISP(6)+CWP*CI*CK*CDLAM*CFF
C
      CLDISP(2)=CLDISP(2)+CWP*      CLAM*CFG
      CLDISP(3)=CLDISP(3)-CWP* 2.D0*CBETA*CDLAM*CFW
      CLDISP(4)=CLDISP(4)-CWP*   CK*CBLAM*CFF
      CLDISP(6)=CLDISP(6)+CWP*CI*CK*CDLAM*CFF
C
