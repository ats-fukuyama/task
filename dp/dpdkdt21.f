...
!--------------diffrerential of g(v,theta),DGP,DGT----------!
     ...
     &              *TSNM(NTH)*ECHI2(NCH2))/RSL    
         DGT(NTH,NP)=DKPP*PV(NP)*TCSM(NTH)-(MM*AA
     &        *TCSM(NTH)*TSNM(NTH)*ECHI2(NCH2))/RSL
      ENDDO
      ENDDO
C------------------------------------------------------!
...
C
            CDENX = CW-DKPRX+MM*AA*PV(NP)*(1+TCSM2(NTH))*ECHI2(NCH2)
     &                                                     /(2*RSL)
...
C
            CPART12=(MM*AA**2*PV(NP)**4*(1+TCSM2(NTH))**2*ECHI2(NCH2)
...
C
            ...
            PI1=(AA/4)**2*PV(NP)**4*(1+TCSM2(NTH))**2
            PI2=(AA/2)*PV(NP)**3*(1+TCSM2(NTH))*TCSM(NTH)
            PI3=PV(NP)**2*TCSM2(NTH)
C
C
         CINTG111 = CINTG111 + CDEN*CPART14*PI1*ECHI1(NCH1)*ECHI2(NCH2)
         CINTG112 = CINTG112 + CDEN*CPART14*PI1*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG113 = CINTG113 + CDEN*CPART14*PI2*ECHI1(NCH1)
         CINTG121 = CINTG121 + CDEN*CPART14*PI1*SCHI1(NCH1)*ECHI2(NCH2)
         CINTG122 = CINTG122 + CDEN*CPART14*PI1*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG123 = CINTG123 + CDEN*CPART14*PI2*SCHI1(NCH1)
         CINTG131 = CINTG131 + CDEN*CPART14*PI2*ECHI2(NCH2)
         CINTG132 = CINTG132 + CDEN*CPART14*PI2*SCHI2(NCH2)
...
C 
            ...
            PI3=PV(NP)**2*TCSM2(NTH)
C
         CINTG211 = CINTG211 + CDEN*CPART2*PI1*ECHI1(NCH1)*ECHI2(NCH2)
         CINTG212 = CINTG212 + CDEN*CPART2*PI1*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG213 = CINTG213 + CDEN*CPART2*PI2*ECHI1(NCH1)
         CINTG221 = CINTG221 + CDEN*CPART2*PI1*SCHI1(NCH1)*ECHI2(NCH2)
         CINTG222 = CINTG222 + CDEN*CPART2*PI1*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG223 = CINTG223 + CDEN*CPART2*PI2*SCHI1(NCH1)
         CINTG231 = CINTG231 + CDEN*CPART2*PI2*ECHI2(NCH2)
         CINTG232 = CINTG232 + CDEN*CPART2*PI2*SCHI2(NCH2)
...
C        
         CPART32=(MM*AA**2*PNEAR1**4*(1+TCSM2(NTH))**2*ECHI2(NCH2)
     &        *SCHI2(NCH2)*(DPFP(NTH,NP)-CWAST(NTH,NP)/CW)/(4*CDENX))
C
...
C
     ...
     &        /(ABS(-DKPP*TCSM(NTH)
     &        +MM*AA*PNEAR1*(1+TCSM2(NTH))*ECHI2(NCH2)))
C
         PI11=(AA/4)**2*PNEAR1**4*(1+TCSM2(NTH))**2
         PI12=(AA/2)*PNEAR1**3*(1+TCSM2(NTH))*TCSM(NTH)
         PI13=PNEAR1**2*TCSM2(NTH)
C
C
         CINTG311 = CINTG311 + CPART36*PI11*ECHI1(NCH1)*ECHI2(NCH2)
         CINTG312 = CINTG312 + CPART36*PI11*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG313 = CINTG313 + CPART36*PI12*ECHI1(NCH1)
         CINTG321 = CINTG321 + CPART36*PI11*SCHI1(NCH1)*ECHI2(NCH2)
         CINTG322 = CINTG322 + CPART36*PI11*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG323 = CINTG323 + CPART36*PI12*SCHI1(NCH1)
         CINTG331 = CINTG331 + CPART36*PI12*ECHI2(NCH2)
         CINTG332 = CINTG332 + CPART36*PI12*SCHI2(NCH2)
         CINTG333 = CINTG333 + CPART36*PI13
       ENDDO
C
C
C*****************SUM4************************
...
C     
         CPART42=(MM*AA**2*PNEAR2**4*(1+TCSM2(NTH))**2*ECHI2(NCH2)
     &        *SCHI2(NCH2)*(DPFP(NTH,NP)-CWAST(NTH,NP)/CW)/(4*CDENX))
C
...
C
C
         PI21=(AA/4)**2*PNEAR2**4*(1+TCSM2(NTH))**2
         PI22=(AA/2)*PNEAR2**3*(1+TCSM2(NTH))*TCSM(NTH)
         PI23=PNEAR2**2*TCSM2(NTH)
C
C
         CINTG411 = CINTG411 + CPART46*PI21*ECHI1(NCH1)*ECHI2(NCH2)
         CINTG412 = CINTG412 + CPART46*PI21*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG413 = CINTG413 + CPART46*PI22*ECHI1(NCH1)
         CINTG421 = CINTG421 + CPART46*PI21*SCHI1(NCH1)*ECHI2(NCH2)
         CINTG422 = CINTG422 + CPART46*PI21*ECHI1(NCH1)*SCHI2(NCH2)
         CINTG423 = CINTG423 + CPART46*PI22*SCHI1(NCH1)
         CINTG431 = CINTG431 + CPART46*PI22*ECHI2(NCH2)
         CINTG432 = CINTG432 + CPART46*PI22*SCHI2(NCH2)
