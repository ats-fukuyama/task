...
C
      WRITE(26) (((CAFF(NZ,I,IN),NZ=1,NZMAX),I=1,4),IN=1,NNOD)
      ...
      IF(NZMAX.GT.1) THEN
         WRITE(26) (RKZF(NZ),NPHIF(NZ),PWRF(NZ),NZ=1,NZMAX)
...
C
      READ(26,ERR=9100,END=9200) 
     &     (((CAFF(NZ,I,IN),NZ=1,NZMAX),I=1,3),IN=1,NNOD)
      READ(26,ERR=9100,END=9200) 
     ...
     &     ((PWRRS(NR,NS),NR=1,NRMAX),NS=1,NSMAX)
      IF(NZMAX.GT.1) THEN
         READ(26,ERR=9100,END=9200) 
     &        (RKZF(NZ),NPHIF(NZ),PWRF(NZ),NZ=1,NZMAX)
         READ(26,ERR=9100,END=9200) 
