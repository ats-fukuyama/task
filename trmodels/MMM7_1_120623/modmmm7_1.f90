...
If ( Present( cmmm ) ) Then
   ...
   cmmm(1,KW20) = 1.0_R8
   If (Present(KW20_C_EXB)) cmmm(1,KW20) = KW20_C_EXB

   cmmm(2,KW20) = 1._R8
   If (Present(KW20_C_MOM_PINCH_SCALE)) cmmm(2,KW20) = KW20_C_MOM_PINCH_SCALE

   cmmm(3,KW20) = 1E-4_R8
   If (Present(KW20_C_XTE_MIN)) cmmm(3,KW20) = KW20_C_XTE_MIN

   cmmm(4,KW20) = 1E+2_R8
   If (Present(KW20_C_XTE_MAX)) cmmm(4,KW20) = KW20_C_XTE_MAX

   cmmm(5,KW20) = 1E-4_R8
   If (Present(KW20_C_XTI_MIN)) cmmm(5,KW20) = KW20_C_XTI_MIN

   cmmm(6,KW20) = 1E+2_R8
   If (Present(KW20_C_XTI_MAX)) cmmm(6,KW20) = KW20_C_XTI_MAX
