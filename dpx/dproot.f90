...
2      WRITE(6,*) ' INPUT : RF1,RF2,NXMAX'
       ...
       IF(NXMAX.LE.0) GOTO 1
       ALLOCATE(GX(NXMAX),GY(NXMAX))
       DRF=(RF2-RF1)/NXMAX
       DO NX=1,NXMAX
...
!     *************************
  ...
  SUBROUTINE DP_ROOT
    ...
    INTEGER,DIMENSION(:),ALLOCATABLE::  NXMAXA
...
202    WRITE(6,*) ' INPUT : RKX1,RKX2,NXMAX'
       ...
       ALLOCATE(GX(NXMAX),GY(NXMAX),GY2(NXMAX))
...
802    WRITE(6,*) ' INPUT : RX1,RX2,NXMAX,RKX0'
       ...
       ALLOCATE(GX(NXMAX),GY(NXMAX),GY2(NXMAX),NXMAXA(IGMAX))
       I=I+1
       DXPOS=(RX2-RX1)/(NXMAX-1)
       CRF0=CMPLX(RF0,0.D0)
       CKX=CMPLX(RKX0,0.D0)
       ...
       DEALLOCATE(GX,GY,GY2,NXMAXA)
       IF(I.LT.IGMAX) GOTO 802
8000   CONTINUE
       CALL DPGR1B(GXA,GYA,GY2A,NXMAX,NXMAXA,I,ISW)
    ENDIF
