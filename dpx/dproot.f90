...
102    WRITE(6,'(A,1P2E12.4,I5)') &
       ...
       DO NX=1,NGXMAX
          CRF=CMPLX(RF0,RFI1)+CMPLX(0.D0,DRFI)*(NX-1)
          CKX=RKX0
          CKY=RKY0
          CKZ=RKZ0
          CD=CFDISP(CRF,CKX,CKY,CKZ,RX0,RY0,RZ0)
...
802    WRITE(6,'(A,1P2E12.4,I5,1PE12.4)') &
       ...
       ALLOCATE(GX(NGXMAX),GY(NGXMAX),GY2(NGXMAX),NGXMAXA(IGMAX))
       I=I+1
       DXPOS=(RX2-RX1)/(NGXMAX-1)
       CRF0=CMPLX(RF0,0.D0)
       CKX=CMPLX(RKX0,0.D0)
