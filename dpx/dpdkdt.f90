    ...
    COMPLEX(rkind):: CD4(6),CD5(6),CD6(6),CDC(9),CDH(9),CDK(9)
    COMPLEX(rkind):: CW,CKPR,CKPP,CZ,CFZ
    REAL(rkind):: RF0_SAVE,RKZ0_SAVE,RKX0_SAVE,RL,RHON,RKPR0
    REAL(rkind):: XMIN,XMAX,X,DX,Q
    INTEGER MODE,NID,I,MODELP_SAVE,NS,MM,NR,NCH1,NCH2,NX,IERR,NXGMAX
    REAL(4):: GUCLIP
...
!         CALL DPFPGRA(PMAX,NTHM,NPMAX,NTHMAX,PM,THM,FNS(1,1,3,NS),'F2')
       ...
       WRITE(6,612) 
612    FORMAT(8X,'  COLD  ',16X,'  HOT   ', 16X,' DPDKDT ')
       CDC(1)= CD4(1)
       CDC(2)= CD4(5)
       CDC(3)= CD4(4)
       CDC(4)=-CD4(5)
