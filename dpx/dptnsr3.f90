...
!     ****** KINETIC MODEL WITH FLR and Drift (by Swanson) ******
    ...
    SUBROUTINE DPTNKD(CW,CKPR,CKPP,NS,mag,plf,CLDISP)
      ...
      COMPLEX(rkind):: CWP,CWC,CUP,CBETA,CGZ,CZ,CDZ,CKPRL
...
!         IF(NC.LT.0) CBLAM=-CBLAM
         ...
         CK2=  -CI*CWX*NC      *CDLAM*(CGX*CZ+0.5D0*CKX*CTX*CDZ)
         CK3=-     CWX*CWX*(1.D0-NC*CWC/CW)*CLAM &
                          *((1.D0-NC*CWC/CW*(1.D0-WTPR/WTPP))*CDZ &
                            -2.D0*NC*CWC/CW*WTPR/WTPP*CUP/VTPR*CZ)
         CK4=     -CKPP/CKPRL*CW/CWC*CBLAM &
                          *(-NC*CWC/CW*CUP/VTPR*CZ &
                            +0.5D0*(WTPP/WTPR+NC*CWC/CW*CTX)*CDZ)
         CK5=  -CI*CKPP/CKPR*CW/CWC*CDLAM &
                          *(-NC*CWC/CW*CUP/VTPR*CZ &
                            +0.5D0*(WTPP/WTPR+NC*CWC/CW*CTX)*CDZ)
