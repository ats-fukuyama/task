...
C
      ...
      END
C
      SUBROUTINE PLDATA_SETP(RNPL1,RTPL1,RUPL1)
C
      INCLUDE 'plcomd.inc'
...
C
      DO NS=1,NSMAXPL
         CALL SPL1DF(RHOL,RNPL1(NS),URPL,URNPL(1,1,NS),
     &               NRMAXPL+2,IERR)
         IF(IERR.NE.0) 
     &        WRITE(6,*) 'XX PLDATA_GETPL/RN: SPL1DF ERROR: IERR=',IERR
         CALL SPL1DF(RHOL,RTPL1(NS),URPL,URTPL(1,1,NS),
     &               NRMAXPL+2,IERR)
         IF(IERR.NE.0) 
     &        WRITE(6,*) 'XX PLDATA_GETPL/RT: SPL1DF ERROR: IERR=',IERR
         CALL SPL1DF(RHOL,RUPL1(NS),URPL,URUPL(1,1,NS),
     &               NRMAXPL+2,IERR)
         IF(IERR.NE.0) 
