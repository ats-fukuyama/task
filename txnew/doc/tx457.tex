...
%
%  neoclassical poloidal rotation drive
%
%  + \mu_{e2} \frac{\Bph}{\Bth^2} \frac{1}{\me e} \ddr \Te
  + F_{\r{e}\theta}^\r{neo}
\\[5mm]
%=============%
% \nee \ueph  %
...
%  neoclassical poloidal rotation drive
%
%  - \mu_{i2} \frac{\Bph}{\Bth^2} \frac{1}{\mi \Zi e} \ddr \Ti
  + F_{\r{i}\theta}^\r{neo}
%
  + T_{\r{i}\theta}
\\[5mm]
...
%  + r \nu_\r{eHL} u_{\r{H}\phi} u_{\r{H}\theta} \nee \ueph
%
%  + 2 \mu_{e2} \frac{\Bph}{\Bth^2} \frac{s}{\me e \nee} \dds \red{\nee\Te}
%
%  - 2 \mu_{e2} \frac{\Bph}{\Bth^2} \frac{s}{\me e \nee^2} \dd{\nee}
%  \red{\nee\Te}
  + r F_{\r{e}\theta}^\r{neo}
...
%  + r \nu_\r{iHL} u_{\r{H}\phi} u_{\r{H}\theta} \ni \uiph
%
%  - 2 \mu_{i2} \frac{\Bph}{\Bth^2} \frac{s}{\mi \Zi e \ni} \dds \red{\ni\Ti}
%
%  + 2 \mu_{i2} \frac{\Bph}{\Bth^2} \frac{s}{\mi \Zi e \ni^2} \dd{\ni} \red{\ni\Ti}
  + F_{\r{i}\theta}^\r{neo}
%
