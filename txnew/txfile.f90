...
SUBROUTINE TXSAVE
  use tx_commons, only : &
       ...
       & IGBDF,MDFIXT,MDBEAM,MDOSQZ,MDLETA,MDLNEO,MDANOM, &
  ...
  WRITE(21) MODEG,MODEAV,MODEGL,IDIAG,MDLPCK,MODECV,oldmix,iSUPG2,iSUPG3,iSUPG6,SUPGstab,IGBDF,MDFIXT,MDBEAM,MDOSQZ,MDLETA,MDLNEO,MDANOM
...
SUBROUTINE TXLOAD(IST)
  ...
  READ(21) MODEG,MODEAV,MODEGL,IDIAG,MDLPCK,MODECV,oldmix,iSUPG2,iSUPG3,iSUPG6,SUPGstab,IGBDF,MDFIXT,MDBEAM,MDOSQZ,MDLETA,MDLNEO,MDANOM
