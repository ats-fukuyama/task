...
C
      DO I=1,NSRMAX*NTHPTS
         GXPLOT(I)=GCLIP(XPLOT(I))
         GYPLOT(I)=GCLIP(YPLOT(I))
      ENDDO
C
      CALL PAGES
C
...
C      CALL GDEFIN(3.0,23.0,2.0,17.0,GXSMIN,GXMAX,GYMIN,GYMAX)
     ...
     &               GCLIP(ZGMIN),GCLIP(ZGMAX))
      ...
      CALL GVALUE(GXSMIN,2*GXSTP,0.0,0.0,NGVLEN(GXSTP))
      CALL GVALUE(0.0,0.0,GYSMIN,2*GYSTP,NGVLEN(GYSTP))
C
