...
!-----SINGULAR POINT
        CALL SPL2DD(p0N,RHOWM,fa1,DFPa1,DFRa1,PMa0,RHOa0,&
                    US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
 ...
 CONTAINS
  ...
  FUNCTION CFUNC1(x,xm,xp) 
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC1=A0*DFPax*(paN**5)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC1
  ...
  FUNCTION CFUNC2(x,xm,xp)
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC2=A0*DFRax*(paN**6)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC2
  ...
  FUNCTION CFUNC3(x,xm,xp)
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC3=A0*DFPax*(paN**4)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC3
  ...
  FUNCTION CFUNC4(x,xm,xp)
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC4=A0*DFRax*(paN**5)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC4
  ...
  FUNCTION CFUNC5(x,xm,xp)
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC5=A0*DFPax*(paN**3)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC5
  ...
  FUNCTION CFUNC6(x,xm,xp)
    ...
    CALL SPL2DD(paN,RHO0,fax,DFPax,DFRax,PMa0,RHOa0,&
         US(4,4,1:NPMAX,1:NRMAX,NTHv),NPMAX,NPMAX,NRMAX,IERR)
    CFUNC6=A0*DFRax*(paN**4)/(1.D0-paN/Cp0aN)
  END FUNCTION CFUNC6
