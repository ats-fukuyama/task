...
C
      ...
      COMMON /WMSLV1/ AG(6*NBSIZM,2*NCPUMAX*NBSIZM)
      COMMON /WMSLV2/ XG(2*NCPUMAX*NBSIZM)
      COMMON /WMSLV3/ F(6*NBSIZM*2*NBSIZM)
      DIMENSION NM(NBSIZM)
C
      NBSIZ=3*MDSIZ*NDSIZ
      MSIZ=NRMAX*NBSIZ
...
C
     ...
     &        NBSIZM,F,NM,TMPA,TMPG,TMPB,TINV1,TEMP1,TEMP2,
