...
! ***********************************************************
      ...
      REAL(8):: RSUM, FACT, RSUM2, FACT1, FACT2
      REAL(8):: RSUM_SUM, double_count, RSUM_B
      REAL(8),DIMENSION(0:LLMAX_NF,NPSTART:NPEND):: F_LG1, F_LG2, R_1
      REAL(8),DIMENSION(0:LLMAX_NF,NPMAX):: F_LG2_ALL, R_2
