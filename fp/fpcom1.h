...
C
      ...
      COMMON /FPPRM0/ MODELE,MODELA,MODELC,MODELW,LLMAX
...
C
      ...
      COMMON /FPVAR4/ TIME
      COMMON /FPVAR5/ RNE0,RNES,TE0,TES
C
      COMMON /FPPRF1/ RNE(NRM),TE(NRM),WPE(NRM),RNU(NRM),WPE0,RNU0
      COMMON /FPPRF2/ PTH(NRM),BP(NRMP),QR(NRM),PTH0
      COMMON /FPPRF3/ RJ1(NRM),E1(NRM),RJ2(NRM),E2(NRM)
      COMMON /FPPRF4/ EPSR(NRM),THETA(NRM),DKBSR(NRM),THETA0
      COMMON /FPPRF5/ FS1(NTHM,NPM),FS2(NTHM,NPM)
C
