...
C
   30 CONTINUE
      READ(21) RR,RA,RB,RKAP,RDLT,BB,Q0,QA,RIP,PROFJ
      READ(21) NSMAX
      READ(21) (PA(NS),PZ(NS),PN(NS),PNS(NS),PZCL(NS),NS=1,NSMAX)
      READ(21) (PTPR(NS),PTPP(NS),PTS(NS),PU(NS),PUS(NS),NS=1,NSMAX)
      READ(21) PROFN1,PROFN2,PROFT1,PROFT2,PROFU1,PROFU2
      READ(21) RHOMIN,QMIN,RHOITB,PNITB,PTITB,PUITB
      READ(21) (MODELP(NS),NDISP1(NS),NDISP2(NS),NS=1,NSMAX)
      READ(21) MODELG1,MODELN,MODELQ,MODELV
      READ(21) KNAMEQ,KNAMFP
C
      READ(21) NRAYMX
      DO NRAY=1,NRAYMX
         READ(21) NITMAX(NRAY)
