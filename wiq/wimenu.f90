...
CONTAINS
  ...
  SUBROUTINE wi_menu
    ...
    USE wicomm,ONLY: ikind,qkind,wi_deallocate,alfa,beta,xmin,xmax,pn0,any, &
    ...
    REAL(qkind)       :: dx0_save=0.D0,dxmin_save=0.D0
    REAL(qkind)       :: xwmin_save=0.D0,xmax_save=0.D0,xmin_save=0.D0
    REAL(qkind)       :: xwint_save=0.D0
    REAL(qkind)       :: ratea,rk0l
