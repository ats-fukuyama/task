...
#LIBLA=-L/opt/local/lib/lapack -llapack -lblas
...
#OFLAGS = -g -O3 -m64 -std=legacy -mmacosx-version-min=13.0
#DFLAGS = -g -m64 -fbounds-check -ffpe-trap=invalid,zero,overflow -fbacktrace -fcheck=all -std=legacy  -mmacosx-version-min=13.0
