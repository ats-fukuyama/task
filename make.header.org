...
## for macos gfortran (arm64) lib
#GFLIBS=-L/usr/local/lib -lg3d-garm64 -lgsp-garm64 -lgdp-garm64  -L/opt/local/lib -lX11
#OFLAGS = -g -O3 -std=legacy
#DFLAGS = -g -fbounds-check -ffpe-trap=invalid,zero,overflow,underflow -fbacktrace -fcheck=all -std=legacy
#FCFIXED = gfortran -ffixed-form
#FCFREE = gfortran -ffree-form
#MOD = mod
#MODDIR = -Jmod
