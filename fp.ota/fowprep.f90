    ...
    do nsa = 1, nsamax
      do nr = 1, nrmax
        do np = 1, npmax
          ...
          write(*,*)"theta",theta_cnt_stg(np,nr,nsa)*180/pi,theta_co_stg(np,nr,nsa)*180/pi,theta_pnc(np,nr,nsa)*180/pi
        end do
      end do
    end do
