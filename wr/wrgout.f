...
C
      ...
      DIMENSION FRLRO1(0:NRADM+1),FZLRO1(0:NRADM+1)
      DIMENSION FRLRO2(0:NRADM+1),FZLRO2(0:NRADM+1)
      ...
      DIMENSION FASSX1(0:NITM+1,0:NRADM),FASSZ1(0:NITM+1,0:NRADM)
      DIMENSION DELP1(0:NITM+1,0:NRADM),DELP2(0:NITM+1,0:NRADM)
      DIMENSION FASSX2(0:NITM+1,0:NRADM),FASSZ2(0:NITM+1,0:NRADM)
C
      CALL PAGES
      CALL SETFNT(32)
      CALL SETCHS(0.25,0.)
