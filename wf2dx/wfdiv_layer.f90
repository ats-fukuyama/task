...
MODULE wfdiv_layer
  ...
  PRIVATE
  PUBLIC wf_div_layer_input
  PUBLIC wf_div_layer_exec
  
CONTAINS

  SUBROUTINE wf_div_layer_input
    IMPLICIT NONE
...
9   CONTINUE
    RETURN
  END SUBROUTINE wf_div_layer_input
           
  SUBROUTINE wf_div_layer_exec
    USE femcomm
    IMPLICIT NONE
    ...
    END DO
    RETURN
  END SUBROUTINE wf_div_layer_exec
END MODULE wfdiv_layer
