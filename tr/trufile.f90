...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : NTUM, DT, NT, RKAP, RKAPU, RR, RRU, RA, RAU, BB, BBU, PHIA, PHIAU, PNBIU, VOLAU, RMJRHOU, NRMAX, &
     ...
     &                   PROFT2, ANC, PNC, ANFE, PNFE, NSM, PZ, PZFE, PZC, PNSS, PNSSA, ABVRHOG, RDPVRHOG
...
!     ******
     ...
     &                   RN, RNF, RNFU, RNU, RR, RRU, RT, RTU, TTRHO, TTRHOG, TTRHOU, VOLAU, VTOR, WROT, WROTU, RDPVRHOG
      USE TRCOM1, ONLY : INS
      IMPLICIT NONE
      INTEGER(4):: NR
