...
!     ***********************************************************
     ...
     &                  SUMPBM, TIME_INT, TPRST, TSST, VC, VOID
      IMPLICIT NONE
      INTEGER(4) NS, IERR
...
!     ****** INPUT NAMELIST ******
     ...
     &                   MDLEOI, NSMAX, NSZMAX, NSNMAX, KUFDEV, KUFDCG, TIME_INT, MODEP, MDNI, MDLJQ, MDTC, MDLPCK, NTMAX_SAVE
      USE TRCOM3
      IMPLICIT NONE
...
!     ***** CHECK INPUT PARAMETERS *****
      ...
      USE TRCOMM, ONLY : NGTSTP, NRM, NRMAX, NTM, NTMAX
      IMPLICIT NONE
      INTEGER(4), INTENT(OUT):: IERR
...
!     ***********************************************************
     ...
     &                   CSPRS, CWEB, DT, EPSLTR, IZERO, KUFDCG, KUFDEV, LMAXTR, MDCD05, MDEDGE, MDLAD, MDLAVK, MDLCD,      &
     ...
     &                   PLHTOE, PLHTOT, PN, PNBCD, PNBENG, PNBR0, PNBRTG, PNBRW, PNBTOT, PNBVW, PNBVY, PNC, PNFE, PNNU,    &
     &                   PNNUS, PNS, PROFJ1, PROFJ2, PROFN1, PROFN2, PROFT1, PROFT2, PROFU1, PROFU2, PT, PTS, PZ, RA, RDLT, &
     &                   RHOA, RIPE, RIPS, RKAP, RR, TPRST, TSST
      IMPLICIT NONE
...
!     ***********************************************************
     ...
     &                   NSNMAX, NSS, NST, NSTM, NSTMAX, NSV, NSZMAX, PA, PZ, RGFLS, RQFLS
      ...
      INTEGER(4) :: IND, INDH, INDHD, MDANOM, MDSLCT, NA, NEQ, NEQ1, NEQI, NEQRMAX, NEQS, NEQT, NNSC, NNSMAX, NNSN, NR, &
     &              NS, NSSN, NSVN
