...
!     ***********************************************************
     ...
     &                   MDNI, MDPHIA, NRAMAX, NRM, NRMAX, NRMP, NRMU, NTS, NTUM, PBMU, PECU, PHIA, PHIAU, PICU, PN, PNBU, PNS,&
...
!     *** 2D VALUE ***
      ...
      KFID='TEXP'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RTEXU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RTEXU,NRFMAX,NTXMAX,IERR)
      ENDIF
      IF(IERR.EQ.0) THEN
         NREMAX(1)=NRFMAX
      ...
      KFID='TEXPEB'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RTEXEU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RTEXEU,NRFMAX,NTXMAX,IERR)
      ENDIF
!
      KFID='TI'
      CALL UF2DSP(KFID,KUFDEV,KUFDCG,DR,PTMP1,PTMP2,FAS,AMP,RHOA,NRAMAX,NRMAX,MDLXP,IERR)
      ...
      KFID='TIXP'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RTIXU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RTIXU,NRFMAX,NTXMAX,IERR)
      ENDIF
      KFID='TIXPEB'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RTIXEU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RTIXEU,NRFMAX,NTXMAX,IERR)
      ENDIF
      ...
      KFID='NEXP'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RNEXU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RNEXU,NRFMAX,NTXMAX,IERR)
      ENDIF
      IF(IERR.EQ.0) THEN
         NREMAX(2)=NRFMAX
      ...
      KFID='NEXPEB'
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_ERROR(KDIRX,KUFDEV,KUFDCG,KFID,RUF,TMU,RNEXEU,NRFMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_RAW2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RUF,TMU,RNEXEU,NRFMAX,NTXMAX,IERR)
      ENDIF
...
!      ARRHOU(1,1:NRMAX)=1.D0/RMJRHOU(1,1:NRMAX)**2
      ...
      KFID='VOLUME'
      CALL UFREAD2_TIME(KDIRX,KUFDEV,KUFDCG,KFID,RL,TL,F2,NRLMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
...
!     ***********************************************************
     ...
     &                   KUFDCG, KUFDEV, MDLJQ, MDLXP, MDNI, MDPHIA, NRAMAX, NRMAX, NRMP, NRMU, NSM, NTUM, PBMU, PECU, PHIA, &
...
!     *****************************************************************
     ...
     &                   MDLXP, MDPHIA, NRAMAX, NRMAX, NRMP, NRMU, NTUM, PECU, PHIA, PI, PICU, PNBU, PNSU, PNSUA, POHU, &
...
!     *****************************************************
      ...
      USE TRCOMM, ONLY : NRMP, NRMU, NTUM
      ...
      IF(MDLXP.EQ.0) THEN
         CALL UFREAD2_TIME(KDIRX,KUFDEV,KUFDCG,KFID,RL,TL,F2,NRLMAX,NTXMAX,NRMU,NTUM,MDCHK,IERR)
      ELSE
         CALL IPDB_MDS2(KUFDEV,KUFDCG,KFID,NRMU,NTUM,RL,TL,F2,NRLMAX,NTXMAX,IERR)
      ENDIF
...
!     *****************************************************
      ...
      REAL(8),DIMENSION(NTUM,NRMU):: F2
      REAL(8),DIMENSION(4,NRMU):: U
      REAL(8),DIMENSION(NRMU):: DERIV, TMP0
...
!     *** FOR THE VARIABLE WE'D LIKE TO USE PERIPHERAL VALUES ***
     ...
     &                  NTLMAX,NTXMAX,RHOA,NRAMAX,NRMAX,TLMAX,NSW,ICK,MDLXP,IERR)
      ...
      INTEGER(4):: MDCHK, NRL, NRLMAX, NRX, NTX
      REAL(8)   :: RSL, F0, RGN
      REAL(8),DIMENSION(NRMU)     :: DERIV, RL, TMP0
      REAL(8),DIMENSION(4,NRMU)   :: U
      REAL(8),DIMENSION(NTUM,NRMU):: F2
...
!     IERR: negative value means "no data file".
      ...
      USE TRCOMM, ONLY : MDLJQ, NRMU, NTUM, TIME_INT
      IMPLICIT NONE
      CHARACTER(LEN=10)           ,INTENT(IN):: KFID
      REAL(8),DIMENSION(NRMU)     ,INTENT(IN) :: RL
      REAL(8),DIMENSION(NTUM)     ,INTENT(IN) :: TL
      REAL(8),DIMENSION(NTUM,NRMU),INTENT(IN) :: F2
      REAL(8),DIMENSION(4,NRMU)   ,INTENT(OUT):: U
      INTEGER(4),                  INTENT(IN) :: NRFMAX, NTXMAX, ID
      INTEGER(4),                  INTENT(INOUT):: IERR
      INTEGER(4):: NTSL, NTX, NTX_MIN
      REAL(8)   :: TL_MIN, TL_MIN_OLD
      REAL(8),DIMENSION(NRMU):: DERIV, TMP
