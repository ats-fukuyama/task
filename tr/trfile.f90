...
!     ***********************************************************
      ...
      WRITE(21) MDLKAI,MDLETA,MDLADNC,MDLADDW,MDLAVKNC,MDLAVKDW, &
           MDLJBS,MDLKNC,MDLTPF,MDCD05
...
!     ***********************************************************
      ...
      SUBROUTINE tr_load
        ...
        USE TRCOMM, ONLY : ABB2RHOG, ABRHO, ABRHOG, AD0, AIB2RHOG, AJOH, &
             ALP, AMZ, ANC, ANFE, ANNU, AR1RHO, AR1RHOG, AR2RHO,      &
             AR2RHOG, ARHBRHOG, ARRHO, ARRHOG, AV0, BB, BP, CALF, &
             CDH, CDP, CDW, CHP, CK0, CK1, CKALFA, CKBETA,     &
             CKGUMA, CNB, CNH, CNP, CWEB, DR, DT, DVRHO, DVRHOG, EPSLTR, &
             EPSRHO, ETA, EZOH, GRG, GRM, IREAD, IZERO, &
             KFNLOG, KNAMTR, KUFDCG, KUFDEV, LMAXTR, MDCD05, MDDIAG, &
             MDDW, MDLADNC, MDLADDW, MDLAVKNC,MDLAVKDW, MDLCD, MDLEC, &
             MDLEOI, MDLEQ0, MDLEQB, MDLEQE, MDLEQN, MDLEQT, MDLEQU, MDLEQZ, &
             MDLER, MDLETA, MDLFLX, MDLIC, MDLJBS, MDLJQ,   &
             MDLKAI, MDLKNC, MDLLH, MDLNB, MDLNF, MDLPCK, MDLPEL, MDLST, &
             MDLTPF, MDLUF, MDLWLD, MDLXP, MDNCLS,      &
             MDNI, MDTC, MODELG, MODEP, NEA, NEQMAX, NGPST, NGR, NGRSTP, &
             NGST, NGT, NGTSTP, NNS, NRAMAX, NRMAX,     &
             NROMAX, NSMAX, NSNMAX, NSS, NST, NSV, NSZMAX, NTEQIT, &
             NTMAX, NTMAX_SAVE, NTSTEP, PA, PBSCD, PECCD,     &
             PECNPR, PECR0, PECRW, PECTOE, PECTOT, PELPAT, PELR0, &
             PELRAD, PELRW, PELTIM, PELTOT, PELVEL, PHIA, PI,  &
             PICCD, PICNPR, PICR0, PICRW, PICTOE, PICTOT, &
             PLHCD, PLHNPR, PLHR0, PLHRW, PLHTOE, PLHTOT, &
             PN, PNBCD,   &
             PNBENG, PNBR0, PNBRTG, PNBRW, PNBTOT, PNC, PNFE, &
             PNNU, PNNUS, PNS, PNSS, PROFJ1, PROFJ2, PROFN1,       &
             PROFN2, PROFT1, PROFT2, PROFU1, PROFU2, PT, PTS, &
             PZ, Q0, QP, RA, RDLT, RDP, RG, RHOA, RHOG, RHOM, RIPE, &
             RIPS, RJCB, RKAP, RKPRHO, RKPRHOG, RM, RMJRHO, RMNRHO, &
             RN, RNF, RPSI, RR, RT, RTF, RU, RW, T, TIME_INT,&
             TPRE, TPRST, TSST, TST, TTRHO, TTRHOG, VPOL, VSEC, VTOR, &
             WPPRE, ALLOCATE_TRCOMM, ABVRHO, ABVRHOG, RDPVRHOG
      USE libitp
      USE libfio
      IMPLICIT NONE
      INTEGER:: IERR
      ...
      READ(21) PROFN1,PROFN2,PROFT1,PROFT2,PROFU1,PROFU2,PROFJ1,PROFJ2, &
           ALP,AD0,AV0,CNP,CNH,CDP,CDH,CDW,CWEB,CALF,CNB
      READ(21) MDLKAI,MDLETA,MDLADNC,MDLADDW,MDLAVKNC,MDLAVKDW,MDLJBS, &
           MDLKNC,MDLTPF,MDCD05
