...
!     ****************************************
      ...
      USE TRCOMM, ONLY : AJBST, AJTTOR, GRT, GT, GVT, GYT, KUFDCG, KUFDEV, MDLUF, MDLXP, NGT, NRMAX, NTM, NTS, &
...
!     ****************************************************
      ...
      USE TRCOMM, ONLY : GRT, GT, GVT, GYT, MDLUF, NGT, NRMAX, NTM, NTUM, RTU
      USE TRCOM1, ONLY : NTXMAX, TMU
      IMPLICIT NONE
      INTEGER(4), INTENT(IN):: INQ
