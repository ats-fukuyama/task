...
!     ***********************************
     ...
     &                   MDNCLS, NRMAX, NRMP, NSM, NSMAX, PNSS, PTS, RGFLS, RHOG, RHOM, RJCB, RKEV, RN, RQFLS, RT
      IMPLICIT NONE
      INTEGER(4),INTENT(IN):: INQ
...
!     ****************************************
      ...
      USE TRCOMM, ONLY : AJBST, AJTTOR, GVRT, GT, GVT, GYT, KUFDCG, KUFDEV, MDLUF, MDLXP, NGT, NRMAX, NTM, NTS, &
...
!     **********************************************
      ...
      USE TRCOMM, ONLY : GER, GRM, GRM, GYR, MDLUF, NRMAX, NRMP, NRUM, NTUM, RN, RT
...
!     ****************************************************
      ...
      USE TRCOMM, ONLY : GVRT, GT, GVT, GYT, MDLUF, NGT, NRMAX, NTM, NTUM, RTU
      USE TRCOM1, ONLY : NTXMAX, TMU
      IMPLICIT NONE
      INTEGER(4), INTENT(IN):: INQ
