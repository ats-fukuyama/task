...
C         IF(KID.NE.'Y') GOTO 1
   ...
   20    WRITE(6,*) 'XX NEW FILE OPEN ERROR : IOSTAT = ',IST
      ...
      ENDIF
C
 30   WRITE(21) MDLEQB,MDLEQN,MDLEQT,MDLEQU,MDLEQZ,MDLEQ0,MDLEQE,MDLEOI
...
C
   ...
   10    WRITE(6,*) 'XX OLD FILE OPEN ERROR : IOSTAT = ',IST
      ...
      ENDIF
C
 30   READ(21) MDLEQB,MDLEQN,MDLEQT,MDLEQU,MDLEQZ,MDLEQ0,MDLEQE,MDLEOI
...
C
      IF(MODELG.EQ.9) THEN
 2       WRITE(6,*) '# INPUT : LOAD EQFILE NAME (CR TO CANCEL)'
         READ(5,'(A32)',ERR=2,END=900) EQFNAM
         IF(EQFNAM.EQ.' ') GOTO 900
         INQUIRE(FILE=EQFNAM,EXIST=LEX)
         IF(LEX) THEN
            OPEN(21,FILE=EQFNAM,IOSTAT=IST,STATUS='OLD',ERR=12,
     &           FORM='UNFORMATTED')
            WRITE(6,*) '# OLD FILE (',EQFNAM,') IS ASSIGNED FOR INPUT.'
            GOTO 32
 12         WRITE(6,*) 'XX OLD FILE OPEN ERROR : IOSTAT = ',IST
            GOTO 2
         ELSE
