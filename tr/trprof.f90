...
!     ***********************************************************
     ...
     &                   RKPRHOU, RM, RMJRHO, RMJRHOU, RMNRHO, RMNRHOU, RR, TTRHO, TTRHOU, VOLAU, ABVRHO, ABVRHOG
      IMPLICIT NONE
      INTEGER(4) :: NR
      REAL(8)    :: RKAPS, RHO_A
...
!     ***********************************************************
     ...
     &                   BB, DVRHO, DVRHOG, EPSRHO, NRMAX, RG, RKPRHO, RKPRHOG, RM, TTRHO, TTRHOG, ABVRHO, ABVRHOG
      IMPLICIT NONE
      INTEGER(4) :: NR
      REAL(8)    :: RGL
