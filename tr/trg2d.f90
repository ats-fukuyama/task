...
!     **************************************************************
      ...
      USE TRCOMM, ONLY : GRM, GTR, GRT, NGT, NRM, NGM, NRMAX, NRAMAX, NROMAX, RHOA
      IMPLICIT NONE
      INTEGER(4),       INTENT(IN):: NMB, INQ
      CHARACTER(LEN=80),INTENT(IN):: STR, KV
      REAL(4) :: GX1, GX2, GY1, GY2
      REAL(4),DIMENSION(NRM,NGM) :: GVD

      GVD(1:NRMAX,1:NGT) = GRT(1:NRMAX,1:NGT,NMB)
      ...
      CALL PAGES
      CALL TRGR3D(GX1,GX2,GY1,GY2,GRM,GTR,GVD,NRM,NRMAX,NGT,STR,KV,2+INQ)
      CALL PAGEE
...
!     ***********************************************************
      ...
      CHARACTER(LEN=80),             INTENT(IN):: STR,KV
      INTEGER(4) :: I, NGULEN
      REAL(4)    :: GOX, GOY, GOZ, GPHI, GRADIUS, GSTEPX, GSTEPY, GSTEPZ, GSXMAX, GSXMIN, GSYMAX, GSYMIN, GSZMAX, &
