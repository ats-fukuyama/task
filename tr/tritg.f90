...
!   *************************************************************
     ...
     &                   MDLEQN, MDLEQT, MDLKAI, MDLUF, NGLF, NRM, NRMAX, NSM, NSMAX, PA, PHIA, PI, PZ, Q0, QP, RA, RG,  &
...
!***********************************************************************
      ...
      USE TRCOMM, ONLY : AR1RHOG, AR2RHOG, BB, DR, EPSRHO, MDDW, MDLKAI, MDLTPF, NGLF, NRM, NRMAX, NT, PA, PNSS, PTS, PZ, &
...
!     ****************************************************************
      ...
      USE TRCOMM, ONLY : ADDW, ADDWD, ADDWP, AKDW, AKDWD, AKDWP, MDLWLD, NGLF, NRM, NSM, PA
      IMPLICIT NONE
      INTEGER(4)  :: NR
...
!     ***********************************************************
      ...
      SUBROUTINE IFSPPPL_DRIVER(NRM,NSM,NSTM,NRMAX,RN,RR,DR,RJCB,RHOG,RHOM,QP,S,EPSRHO,RKPRHOG, &
     &                          RT,BB,AMM,AME,PNSS,PTS,RNFL,RBEEDG,MDLUF,NSMAX,AR1RHOG,AR2RHOG,AKDW)

      IMPLICIT NONE

      INTEGER(4),INTENT(IN):: NRM,NSM,NSTM,NRMAX,MDLUF,NSMAX
