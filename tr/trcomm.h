...
C
      COMMON /TRADD1/ VV(NVM-1,NVM-1,3,3)
      COMMON /TRADD2/ DD(NVM-1,NVM-1,3,3)
      COMMON /TRADD3/ VI(NVM-1,NVM-1,2,3),DI(NVM-1,NVM-1,2,3)
      COMMON /TRADD4/ GRN(NRM,NSM)
      COMMON /TRADD5/ FA(3,3),FB(3,3)
      COMMON /TRADD6/ RTM(NSM),AMZ(NSM)
      COMMON /TRADD7/ MDCHG,MDLEQ
