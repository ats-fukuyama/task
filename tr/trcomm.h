...
C
      ...
      COMMON /TRCTL2/ DR,FKAP,PNSS(NSTM)
      COMMON /TRCTL3/ VSEC
...
C
      ...
      COMMON /TREQV6/ EKAPPA(NRM),RMJRHO(NRM),RMNRHO(NRM)
C
C     ****** LOG FILE NAME ******
C
...
C
      ...
      COMMON /TRNCL8/ AKNCLD(NRM,NSM,NSM),AKNCLN(NRM,NSM,NSM)
      COMMON /TRNCL9/ ADNCLD(NRM,NSM,NSM),ADNCLN(NRM,NSM,NSM)
