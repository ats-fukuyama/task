...
C
      IMPLICIT REAL (KIND=8) (A-F,H,O-Z)
C
      PARAMETER (NRM=50,NSM=4,NFM=2,NTM=1001,NGM=101)
      PARAMETER (NCGM=20,NCTM=300)
      PARAMETER (NVM=2*NSM+1,MWM=4*NVM-1,MLM=NVM*NRM)
      PARAMETER (NRMP=NRM+1)
C      CHARACTER(40) :: KGR1,KGR2,KGR3,KGR4
C      CHARACTER(40) :: KFNLOG
      CHARACTER KGR1*40,KGR2*40,KGR3*40,KGR4*40
      CHARACTER KFNLOG*40
C
C     ****** CONSTANTS ******
C
...
C
      COMMON /TRADD1/ VV(NVM-1,NVM-1,4,3)
      COMMON /TRADD2/ DD(NVM-1,NVM-1,4,3)
      COMMON /TRADD3/ VI(NVM-1,NVM-1,2,3),DI(NVM-1,NVM-1,2,3)
      COMMON /TRADD4/ FA(3,3),FB(3,3)
      COMMON /TRADD5/ RTM(NSM),AMZ(NSM)
      COMMON /TRADD6/ MDCHG,MDLEQ
