...
!     ****** INPUT NAMELIST ******
    ...
    SUBROUTINE tr_nlin(NID,IST,IERR)
      ...
      NAMELIST /TR/ RR,RA,RKAP,RDLT,BB,RIPS,RIPE,RHOA, &
                    ...
                    CWEB,CALF,CNB,CSPRS, &
                    MDLKAI,MDLETA,MDLADNC,MDLADDW,MDLAVKNC,MDLAVKDW, &
                    MDLJBS,MDLKNC,MDLTPF, &
...
!     ***** INPUT PARAMETER LIST *****
  ...
  601 FORMAT(' ','# &TR : RR,RA,RKAP,RDLT,BB,RIPS,RIPE,RHOA'/ &
             ...
             ' ',8X,'AD0,CHP,MDLADNCmMDLADDW,MDLAVKNC,MDLAVKDW,'/ &
             ' ',8X,'CKGUMA,MDLKAI,MDLETA,MDLJBS'/ &
...
!     ***********************************************************
  ...
  612    FORMAT(' ',I2,1PD12.4,0P,F8.3,5F9.4)
      ...
      WRITE(6,602) 'MDLKAI',MDLKAI,'MDLETA',MDLETA
      WRITE(6,622) 'MDLADNC ',MDLADNC,  'MDLADDW', MDLADDW
      WRITE(6,622) 'MDLAVKNC',MDLAVKNC, 'MDLAVKDW',MDLAVKDW
