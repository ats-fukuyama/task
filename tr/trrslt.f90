...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY :ABRHOG, AJ, AJBS, AJBST, AJNB, AJNBT, AJOH, AJOHT, AJRF, AJRFT, AJRFV, AJRFVT, AJT, AJTOR, AJTTOR,     &
     &                  ALI, ANF0, ANFAV, ANLAV, ANS0, ANSAV, BB, BETA, BETA0, BETAA, BETAL, BETAN, BETAP, BETAP0, BETAPA,     &
     &                  BETAPL, BETAQ, BETAQ0, BP, DD, DR, DVRHO, DVRHOG, EZOH, H98Y2, MDLUF, NEQMAX, NFM, NRAMAX, NRM, NRMAX, &
     &                  NROMAX, NSM, NSS, NSV, PA, PBCL, PBCLT, PBIN, PBINT, PBM, PCX, PCXT, PEX, PEXST, PEXT, PFCL, PFCLT,    &
     &                  PFIN, PFINT, PI, PIE, PIET, PINT, PLT, PNB, PNBT, PNF, PNFT, PNSS, POH, POHT, POUT, PRF, PRFST, PRFT,  &
     &                  PRFV, PRFVT, PRL, PRLT, PTS, Q0, QF, QP, RA, RDP, RG, RHOA, RIP, RKAP, RKEV, RM, RMJRHO, RMU0, RN, RNF,&
     &                  RQ1, RR, RT, RW, SIE, SIET, SINT, SLT, SNB, SNBT, SNF, SNFT, SOUT, SPE, SPET, T, TAUE1, TAUE2, TAUE89, &
     &                  TAUE98, TF0, TFAV, TPRE, TS0, TSAV, VLOOP, VV, WBULKT, WFT, WPDOT, WPPRE, WPT, WST, WTAILT, ZEFF, ZEFF0
      IMPLICIT NONE
      INTEGER(4):: NEQ, NF, NMK, NR, NRL, NS, NSSN, NSSN1, NSVN, NSVN1, NSW, NW
      REAL(8)   :: ANFSUM, C83, DRH, DV53, FCTR, PAI, &
     &             PLST, RNSUM, RNTSUM, RTSUM, RWSUM, SLST, SUMM, SUML, SUMP, VOL, WPOL
...
!     +++ for fast particles +++
      ...
      ELSE
         DO NF=1,NFM
            ANFSUM = SUM(RNF(1:NRMAX,NF)*DVRHO(1:NRMAX))
            RWSUM  = SUM(RW (1:NRMAX,NF)*DVRHO(1:NRMAX))
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : AJ, AJBS, AJBST, AJNB, AJNBT, AJOH, AJOHT, AJRF, AJRFT, AJRFV, AJT, AJTTOR, AK, AKDW, ALI, ANC, ANF0,    &
     &                   ANFAV, ANFE, ANLAV, ANS0, ANSAV, AR1RHO, AR2RHO, BB, BETA, BETA0, BETAA, BETAP, BETAP0, BETAPA, BP, DR,  &
     &                   DVRHO, ER, ETA, EZOH, G3D, GT, GVT, H98Y2, NGT, NRAMAX, NRM, NRMAX, NROMAX, NTM, PBCLT, PBINT, PCX, PCXT,&
     &                   PEX, PEXT, PFCLT, PFINT, PI, PIE, PIET, PINT, PLT, PNB, PNBT, PNF, PNFT, POH, POHT, POUT, PRF, PRFT,     &
     &                   PRFV, PRFVT, PRL, PRLT, Q0, QF, QP, RA, RHOA, RIP, RKAP, RKPRHO, RM, RMJRHO, RMNRHO, RN, RPSI, RQ1, RR,  &
     &                   RT, RW, S, ALPHA, SIET, SINT, SLT, SNBT, SNFT, SOUT, T, TAUE1, TAUE2, TAUE89, TAUE98, TF0, TFAV, TS0,    &
     &                   TSAV, VLOOP, VPOL, VTOR, WBULKT, WFT, WPDOT, WPT, WST, WTAILT, ZEFF, ZEFF0, RKCV
      IMPLICIT NONE
      INTEGER(4):: IERR, NR
      REAL(8)   :: RMN, F0D
      REAL(8),DIMENSION(NRM):: DERIV, U0
      REAL(8),DIMENSION(4,NRM):: U
      REAL(8)   :: TRCOFS
      REAL(4)   :: GUCLIP
...
!     *****
      ...
      USE TRCOM2, ONLY : KDIRW1, KXNDCG, KXNDEV
      IMPLICIT NONE
      CHARACTER(LEN=80)     ,INTENT(IN):: KFID
...
!     *****
      ...
      USE TRCOM2, ONLY :KDIRW2, KXNDCG, KXNDEV
      IMPLICIT NONE
      CHARACTER(LEN=80)         ,INTENT(IN):: KFID
