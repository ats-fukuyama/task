...
!     ***********************************************************
     ...
     &                   NRMAX, NSM, NSMAX, NSTM, PA, PADD, PBM, PI, PNSS, PTS, PZ, Q0, QP, RA, RHOG, RHOM, RJCB, RKAP,&
     &                   RKEV, RKPRHO, RKPRHOG, RM, RMU0, RN, RNF, RR, RT, RW, S, ALPHA, RKCV, SUMPBM, TAUK, VC, VEXB, &
     &                   VGR1, VGR2, VGR3, VGR4, WEXB, ZEFF, RDPS
      IMPLICIT NONE
