...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : GT, GVRT, GRM, RTU, NGT, NTM, NRM, NRMAX, MDLUF
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : GT, GRG, GRM, GVRT, NGT, NTM, NRM, NRMAX
      IMPLICIT NONE
      INTEGER(4), INTENT(IN):: INQ
      INTEGER(4) :: I
      REAL(4),DIMENSION(NTM,NRM) :: GYL
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : DR, GRM, GT, GTS, GYT, GVT, MDLUF, NGT, NGST, NGPST, NRM, NRMAX, NTM, IZERO
