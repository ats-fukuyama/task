...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : GT, GRT, GRM, RTU, NGT, NTM, NRM, NRMAX, MDLUF
      ...
      DO I=1,NGT
         GYL(I,1:NRMAX) = GRT(1:NRMAX,I,13) * 1.E-6
      ENDDO
      CALL TRGR1DC(15.0,24.0, 5.4, 8.4,GT,GRM,GYL,NTM,NGT,NRM,NRMAX,'@AJBS [MA]  vs t@')

      DO I=1,NGT
         GYL(I,1:NRMAX) = (GRT(1:NRMAX,I,11) + GRT(1:NRMAX,I,12)) * 1.E-6
      ENDDO
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : GT, GRG, GRM, GRT, NGT, NTM, NRM, NRMAX
      IMPLICIT NONE
      INTEGER(4), INTENT(IN):: INQ
      INTEGER(4) :: I
      REAL(4),DIMENSION(NTM,NRM) :: GYL
...
!     ***********************************************************
      ...
      USE TRCOMM, ONLY : DR, GRT, GRM, GT, GTS, GYT, GVT, MDLUF, NGT, NGST, NGPST, NRM, NRMAX, NTM, IZERO
